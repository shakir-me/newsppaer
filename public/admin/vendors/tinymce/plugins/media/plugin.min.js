...
!(function () {
    ...
    var e,
        ...
        z = function (a, e) {
            ...
            return (
                P({
                    ...
                    start: function (e, t) {
                        if (!c.get())
                            if (k(t.map, "data-ephox-embed-iri"))
                                c.set(!0),
                                    (o = (n = t).map.style),
                                    (i = o ? $.parseStyle(o) : {}),
                                    (u = {
                ...
                if (i.map[t])
                    for (var n = i.length; n--; ) {
                        ...
                        o.name === t &&
                            (r
                                ? ((i.map[t] = r), (o.value = r))
                                : (delete i.map[t], i.splice(n, 1)));
                    }
                else r && (i.push({ name: t, value: r }), (i.map[t] = r));
            });
        },
        I = ["source", "altsource"],
        q = function (e, c, u) {
                ...
                ? ((o = t),
                  ...
                  new H(function (t, e) {
                      var r = function (e) {
                          return (
                              e.html && (J[o.source] = e),
                              t({ url: o.source, html: e.html ? e.html : i(o) })
                          );
                      };
                      J[o.source] ? r(J[o.source]) : a({ url: o.source }, r, e);
                  }))
                : ((r = t),
                  (n = K(e)),
                  new H(function (e) {
        ...
        X = function (e, t) {
            ...
            return p(
                p(
                    p(p(p({}, i("source")), i("altsource")), i("poster")),
                    i("embed")
                ),
                ((r = o),
                (n = {}),
                _(e, "dimensions").each(function (e) {
        ...
        Y = function (e) {
            var n = p(p({}, e), {
                source: { value: _(e, "source").getOr("") },
                altsource: { value: _(e, "altsource").getOr("") },
                poster: { value: _(e, "poster").getOr("") },
            });
            return (
                b(["width", "height"], function (r) {
        ...
        ne = function (e, t, r) {
            ...
            (t.embed = q(t.embed, t)),
                t.embed &&
                (e.source === t.source || ((n = t.source), J.hasOwnProperty(n)))
                    ? re(r, t.embed)
                    : Q(r, t)
                          .then(function (e) {
                              re(r, e.html);
                ...
                h = m.windowManager.open({
                    ...
                    onChange: function (e, t) {
                        switch (t.name) {
                            case "source":
                                (s = d.get()),
                                    (l = X(e.getData(), "source")),
                                    s.source !== l.source &&
                                        (te(h, m)({ url: l.source, html: "" }),
        ...
        de = function (e, t, r) {
            ...
            c &&
                (r.attr("data-mce-html", escape(ue(e, c))),
                (r.firstChild = null));
        },
        fe = function (e) {
            for (; (e = e.parent); )
                ...
                for (var t, r, n, o, i, a, c, u = e.length; u--; )
                    (t = e[u]).parent &&
                        (t.parent.attr("data-mce-object") ||
                            ...
                            ae.ceFalse
                                ? fe(t) || t.replace(me(s, t))
                                : fe(t) ||
                                  t.replace(
                                      ((n = s),
                                      (a = void 0),
                                      (i = (o = t).name),
                                      ((a = new ie("img", 1)).shortEnded = !0),
                                      de(n, o, a),
                                      le(o, a, {}),
                                      a.attr({
                                          style: o.attr("style"),
            ...
            (d = e).on("preInit", function () {
                ...
                T.each(
                    ...
                    d.serializer.addAttributeFilter(
                        ...
                        function (e, t) {
                            for (
                                var r, n, o, i, a, c, u, s, l = e.length;
                                l--;
                                ...
                                if ((r = e[l]).parent) {
                                    for (
                                        u = r.attr(t),
                                            ...
                                            o = (i = r.attributes).length;
                                        o--;

                                    ) {
                                        var m = i[o].name;
                                        0 === m.indexOf("data-mce-p-") &&
                                            n.attr(m.substr(11), i[o].value);
                                    }
                                    "script" === u &&
