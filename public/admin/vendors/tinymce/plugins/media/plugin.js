...
(function () {
        ...
        global$3({
            ...
            start: function (name, attrs) {
                if (isEphoxEmbed.get());
                    ...
                    if (name === "script") {
                        var videoScript = getVideoScriptMatch(
                            prefixes,
                            attrs.map.src
                        );
                        if (!videoScript) {
    ...
    var retainAttributesAndInnerHtml = function (
        ...
        if (innerHtml) {
            targetNode.attr(
                "data-mce-html",
                escape(sanitize(editor, innerHtml))
            );
