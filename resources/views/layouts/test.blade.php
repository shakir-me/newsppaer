...
<head>
  ...
  <title>Shah Technology : Most Popular Online News Portal </title>
  <!-- <meta property="fb:app_id" content="759164018255929" /> -->
  ...
  <![endif]-->
  <!-- <script data-ad-client="ca-pub-5219299595808889" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script> -->
  <script data-ad-client="ca-pub-5357659357616161" async
...
var feedify = feedify || {};
  window.feedify_options={fedify_url:"https://feedify.net/",pkey:"BPXBiktTCklobhiT5P2UYjX0qJfjEm1Bz0v0NTDz7TobCj/+6w6WmNcUKKYIPpzDM3ugaUGpDSfgvnbvMoFo1is="};
...
.fb-box span i {position: absolute;left: 0;display: block;background: #29487d;z-index: 10000;top: -52px;padding: 15px 15px;color: #fff;cursor: pointer;text-decoration: none;font-size: 24px;}
.fb-box span i:hover{background: #3b5a8e;}
...
@media only screen and (max-width: 767px) {
  .fb-box {top: 54%;}
  .fb-box span i {top: -45px;padding: 12px 12px;font-size: 22px;}
...
<!-- Load Facebook SDK for JavaScript -->
      ...
      <div class="fb-customerchat"
        ...
        page_id="335967406472763"
        theme_color="#1877f2"
        greeting_dialog_display="hide"
        logged_in_greeting="Hi! I'm Mekail, your virtual assistant. Let me help you find today's news update"
        logged_out_greeting="Hi! I'm Mekail, your virtual assistant. Let me help you find today's news update"
        >
      </div>
       ...
       <div class="row custom-row">
           <div class="col-12 col-md-4 col-lg-4 d-md-block custom-padding">
                <small class="top-date">
                 ...
                 <!-- মঙ্গলবার , ৩১ আগস্ট , ২০২১, ১৬ ভাদ্র ১৪২৮ -->

                 মঙ্গলবার, ০১ মার্চ, ২০২২, ১৭&nbsp;ফাল্গুন&nbsp;১৪২৮
                </small>
           </div><!--/.col-sm-9-->
      ...
      <div class="col-md-12 col-lg-8 custom-padding d-block d-lg-block">
        <div class="header-banner">
            ...
            <div class="header-banner-left">
              <!-- <a href="https://www.youtube.com/watch?v=bxWRglJFQNc" target="_blank"><img class="img-fluid" src="https://www.ekusheysangbad.com/media/common/top-banner-1.jpg" alt="করোনাভাইরাস মোকাবিলায় মাননীয় প্রধানমন্ত্রীর ৩১ নির্দেশনা"></a> -->
              <a href="https://www.rupalibank.org/" target="_blank"><img class="img-fluid" src="https://www.ekusheysangbad.com/media/common/rupali-bank-animation-ad.gif" alt="Rupalibank"></a>
            </div>
        </div><!--/.header-banner-->
      </div><!--/.col-md-8-->
    </div><!--/.row-->
         ...
         <nav class="bootsnav navbar navbar-transparent">
           ...
           <div class="collapse navbox-collapse" id="navbar-menu">
             <ul class="nav navbar-right" data-in="fade-In-Down" data-out="fade-Out-Up">
               ...
               <li><a id="podcast" href="https://www.ekusheysangbad.com/podcast"><span>পডকাস্ট</span></a></li>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3 col-menu col-12">
                          <ul class="menu-col">
                            ...
                            <li><a href="https://www.ekusheysangbad.com/opinion">ভিডিও</a></li>
                            <li><a href="https://www.ekusheysangbad.com/opinion">পডকাস্ট</a></li>
                          </ul>
                        </div><!--/.col-md-3 col-menu col-sm-6-->
                      </div><!--/.row-->
                    </li>
    ...
    <div class="row custom-row">
      <div class="col-md-12 custom-padding">
        <div class="marquee-block">
          <h2> সংবাদ শিরোনাম :</h2>
          <ul class="marquee">
            <li><a href="https://www.ekusheysangbad.com/sports/news/343539"><span><img class="img-fluid" src="media/common/favicon.ico" alt="নিজেদের উন্নতি বিশ্বকে দেখানোর এটাই সেরা সুযোগ-নিগার"></span> নিজেদের উন্নতি বিশ্বকে দেখানোর এটাই সেরা সুযোগ-নিগার </a></li><li><a href="https://www.ekusheysangbad.com/sports/news/343538"><span><img class="img-fluid" src="media/common/favicon.ico" alt="১০০ টাকায় দেখা যাবে বাংলাদেশ-আফগানিস্তান টি-টোয়েন্টি "></span> ১০০ টাকায় দেখা যাবে বাংলাদেশ-আফগানিস্তান টি-টোয়েন্টি  </a></li><li><a href="https://www.ekusheysangbad.com/country/news/343537"><span><img class="img-fluid" src="media/common/favicon.ico" alt="যদি আওয়ামী লীগ ক্ষমতায় থাকে, আপনারা আর কোনোদিন ভোট দিতে পারবেন নাঃ চট্টগ্রামে মির্জা আব্বাস"></span> যদি আওয়ামী লীগ ক্ষমতায় থাকে, আপনারা আর কোনোদিন ভোট দিতে পারবেন নাঃ চট্টগ্রামে মির্জা আব্বাস </a></li><li><a href="https://www.ekusheysangbad.com/country/news/343536"><span><img class="img-fluid" src="media/common/favicon.ico" alt="রাজশাহীতে অটো গ্যারেজে আগুন, ৬০ লক্ষ টাকার ক্ষয়-ক্ষতি"></span> রাজশাহীতে অটো গ্যারেজে আগুন, ৬০ লক্ষ টাকার ক্ষয়-ক্ষতি </a></li><li><a href="https://www.ekusheysangbad.com/country/news/343535"><span><img class="img-fluid" src="media/common/favicon.ico" alt="কুতুবদিয়া উপজেলা স্বাস্থ্য কমপ্লেক্সে ৮ ডাক্তারের যোগদান "></span> কুতুবদিয়া উপজেলা স্বাস্থ্য কমপ্লেক্সে ৮ ডাক্তারের যোগদান  </a></li>          </ul>
        </div>
        <!--/.marquee-block-->
      </div>
      <!--/.col-md-12-->
        ...
        <div class="new-lead-news">
          <a href="https://www.ekusheysangbad.com/national/news/343531">
            ...
            <div class="new-lead-news-heading">
              ...
              <h1>বিমা নিয়ে হয়রানি বন্ধ করতে হবে-প্রধানমন্ত্রী</h1>
              <p>গ্রাহক যাতে হয়রানির শিকার না হয় সেই বিষয়ে সংশ্লিষ্টদের খেয়াল রাখার অনুরোধ জানিয়ে প্রধানমন্ত্রী শেখ হাসিনা বলেছেন, বিমা মানে আমানত। তাই কেউ যেন তার প্রাপ্য চাইতে গিয়ে হয়রানির শিকার না হয়। বিমা নিয়ে বিভিন্ন হয়রানি হয়, এসব বন্ধ করতে হবে।
...
মঙ্গলবার</p>
        ...
        <div class="meta">
          ...
          <a href="https://www.ekusheysangbad.com/national" class="pull-right">জাতীয়</a>
        </div>
      </div>              </div>
              <!--/.col-md-8-->
        ...
        <div class="lead-news-other-wrapper">
          <div class="lead-news-other">
            <a href="https://www.ekusheysangbad.com/international/news/343519">
              ...
              <h2>কিয়েভ ও খেরসন শহরে ফের হামলা শুরু করেছে রাশিয়া</h2>
              </div>
            </a>
          </div>
          <div class="meta">
            <span class="pull-left tags">
          <i class="fa fa-tags"></i><a href="https://www.ekusheysangbad.com/topic/যুদ্ধ"> যুদ্ধ</a>
        </span>
            <a href="https://www.ekusheysangbad.com/national" class="pull-right">আন্তর্জাতিক</a>
          </div>
        </div>
      </div>
      <div class="col-md-12 col-6 custom-padding">
        <div class="lead-news-other-wrapper">
          <div class="lead-news-other">
            <a href="https://www.ekusheysangbad.com/national/news/343515">
              ...
              <h2>অগ্নিঝরা মার্চ শুরু</h2>
              </div>
            </a>
          </div>
          <div class="meta">
            <span class="pull-left tags">
          <i class="fa fa-tags"></i><a href="https://www.ekusheysangbad.com/topic/স্বাধীনতার মাস"> স্বাধীনতার মাস</a>
        </span>
            <a href="https://www.ekusheysangbad.com/national" class="pull-right">জাতীয়</a>
          </div>
        </div>
      ...
      <div class="col-md-4 col-6 custom-padding">
        <div class="lead-news-second-wrapper">
          ...
          <div class="meta">
            <span class="pull-left tags">
          <i class="fa fa-tags"></i><a href="https://www.ekusheysangbad.com/topic/ফিফা"> ফিফা</a>
        </span>
            <a href="https://www.ekusheysangbad.com/national" class="pull-right">খেলাধুলা</a>
          </div>
        </div>
      </div>
      <div class="col-md-4 col-6 custom-padding">
        <div class="lead-news-second-wrapper">
          ...
          <div class="meta">
            <span class="pull-left tags">
          <i class="fa fa-tags"></i><a href="https://www.ekusheysangbad.com/topic/টি-টোয়েন্টি"> টি-টোয়েন্টি</a>
        </span>
            <a href="https://www.ekusheysangbad.com/national" class="pull-right">খেলাধুলা</a>
          </div>
        </div>
        ...
        <div class="lead-news-second-wrapper">
          <div class="lead-news-second">
            <a href="https://www.ekusheysangbad.com/international/news/343521">
              ...
              <h3>ছবিতে ৪০ মাইল দীর্ঘ রুশ সেনাবহর</h3>
              </div>
            </a>
          </div>
          <div class="meta">
        ...
        <div class="lead-news-second-wrapper">
          <div class="lead-news-second">
            <a href="https://www.ekusheysangbad.com/international/news/343514">
              ...
              <h3>রুশ-ইউক্রেন বৈঠকে যে সিদ্ধান্ত এল</h3>
              </div>
            </a>
          </div>
          <div class="meta">
            <span class="pull-left tags">
          <i class="fa fa-tags"></i><a href="https://www.ekusheysangbad.com/topic/ইউক্রেন"> ইউক্রেন</a>
        </span>
            <a href="https://www.ekusheysangbad.com/national" class="pull-right">আন্তর্জাতিক</a>
          </div>
        </div>
      ...
      <div class="col-md-4 col-6 custom-padding">
        <div class="lead-news-second-wrapper">
          ...
          <div class="meta">
            <span class="pull-left tags">
          <i class="fa fa-tags"></i><a href="https://www.ekusheysangbad.com/topic/করোনা"> করোনা</a>
        </span>
            <a href="https://www.ekusheysangbad.com/national" class="pull-right">আন্তর্জাতিক</a>
          </div>
        </div>
      ...
      <div class="col-md-4 col-6 custom-padding">
        <div class="lead-news-second-wrapper">
          ...
          <div class="meta">
            <span class="pull-left tags">
          <i class="fa fa-tags"></i><a href="https://www.ekusheysangbad.com/topic/বিশ্বকাপ"> বিশ্বকাপ</a>
        </span>
            <a href="https://www.ekusheysangbad.com/national" class="pull-right">খেলাধুলা</a>
          </div>
        </div>
        ...
        <div class="lead-news-second-wrapper">
          <div class="lead-news-second">
            <a href="https://www.ekusheysangbad.com/national/news/343517">
              ...
              <h3>ফরিদপুরের বরকত-রুবেলের আইনজীবীকে হাইকোর্টে তলব</h3>
              </div>
            </a>
          </div>
          <div class="meta">
            <span class="pull-left tags">
          <i class="fa fa-tags"></i><a href="https://www.ekusheysangbad.com/topic/মিথ্যা"> মিথ্যা</a>
        </span>
            <a href="https://www.ekusheysangbad.com/national" class="pull-right">জাতীয়</a>
          </div>
        </div>
      ...
      <div class="col-md-4 col-6 custom-padding">
        <div class="lead-news-second-wrapper">
          ...
          <div class="meta">
            <span class="pull-left tags">
          <i class="fa fa-tags"></i><a href="https://www.ekusheysangbad.com/topic/ডাকাতি"> ডাকাতি</a>
        </span>
            <a href="https://www.ekusheysangbad.com/national" class="pull-right">জাতীয়</a>
          </div>
        </div>
        ...
        <div class="lead-news-right">
          <div class="col-md-12 custom-padding">
            <div class="special-title-heading">
              <h2 class="title">
                <a href="https://www.ekusheysangbad.com/opinion"><span class="text-span"> মতামত </span></a>
        ...
        <li>
          <a href="https://www.ekusheysangbad.com/opinion/news/343476">
            ...
            <div class="opinion-right">
              ...
              <h2>আজম খান : আসি আসি বলে তুমি আর এলে না</h2>
            </div>
          </a>
        </li>
        <li>
          <a href="https://www.ekusheysangbad.com/opinion/news/343363">
            ...
            <div class="opinion-right">
              ...
              <h2>অতিমারির ধাক্কাই কাটল না, এর ওপর ইউক্রেন যুদ্ধ, কী হবে আমাদের?</h2>
            </div>
          </a>
        </li>            </ul>
            <!--/.opinion-->

            <!--================= Start SAHARI AND IFTER TIME SECTION==============-->
            <!-- <div class="panel panel-default distric-wise"> -->
            <!-- <div style="margin-bottom: 24px;">
                <img class="img-fluid" src="media/common/5sehri_times.png" alt="sehri_times">
                <img class="img-fluid" src="media/common/ifter_time5.png" alt="ifter_times">
              </div> -->
            <!-- <div class="panel-heading">আজকের ইফতার ও সাহরি সময়</div>
              <div class="panel-body" style="height: 75px; overflow: hidden;">
                <div class="date-timeinfo" style="width: 100%">
                  <div class="fade13">
                    <div>
                      <table class="table">
                        <tr class="border-n">
                          <td rowspan="2" class="distric">ঢাকা </td>
                          <th>সাহরি</th>
                          <th>ইফতার</th>
                        </tr>
                        <tr>
                          <td id=""><span id="dsh"></span> মিনিট</td>
                          <td id=""><span id="dif"></span> মিনিট</td>
                        </tr>
                      </table>
                    </div>
                    <div>
                      <table class="table">
                        <tr class="border-n">
                          <td rowspan="2" class="distric">চট্টগ্রাম </td>
                          <th>সাহরি</th>
                          <th>ইফতার</th>
                        </tr>
                        <tr>
                          <td id=""><span id="csh"></span> মিনিট</td>
                          <td id=""><span id="cif"></span> মিনিট</td>
                        </tr>
                      </table>
                    </div>
                    <div>
                      <table class="table">
                        <tr class="border-n">
                          <td rowspan="2" class="distric">রাজশাহী </td>
                          <th>সাহরি</th>
                          <th>ইফতার</th>
                        </tr>
                        <tr>
                          <td><span id="rjsh"></span> মিনিট</td>
                          <td><span id="rjif"></span> মিনিট</td>
                        </tr>
                      </table>
                    </div>
                    <div>
                      <table class="table">
                        <tr class="border-n">
                          <td rowspan="2" class="distric">খুলনা </td>
                          <th>সাহরি</th>
                          <th>ইফতার</th>
                        </tr>
                        <tr>
                          <td id=""><span id="ksh"></span> মিনিট</td>
                          <td id=""><span id="kif"></span> মিনিট</td>
                        </tr>
                      </table>
                    </div>
                    <div>
                      <table class="table">
                        <tr class="border-n">
                          <td rowspan="2" class="distric">বরিশাল </td>
                          <th>সাহরি</th>
                          <th>ইফতার</th>
                        </tr>
                        <tr>
                          <td id=""><span id="bsh"></span> মিনিট</td>
                          <td id=""><span id="bif"></span> মিনিট</td>
                        </tr>
                      </table>
                    </div>
                    <div>
                      <table class="table">
                        <tr class="border-n">
                          <td rowspan="2" class="distric">সিলেট </td>
                          <th>সাহরি</th>
                          <th>ইফতার</th>
                        </tr>
                        <tr>
                          <td id=""><span id="ssh"></span> মিনিট</td>
                          <td id=""><span id="sif"></span> মিনিট</td>
                        </tr>
                      </table>
                    </div>
                    <div>
                      <table class="table">
                        <tr class="border-n">
                          <td rowspan="2" class="distric">রংপুর </td>
                          <th>সাহরি</th>
                          <th>ইফতার</th>
                        </tr>
                        <tr>
                          <td id=""><span id="rnsh"></span> মিনিট</td>
                          <td id=""><span id="rnif"></span> মিনিট</td>
                        </tr>
                      </table>
                    </div>
                    <div>
                      <table class="table">
                        <tr class="border-n">
                          <td rowspan="2" class="distric">ময়মনসিংহ </td>
                          <th>সাহরি</th>
                          <th>ইফতার</th>
                        </tr>
                        <tr>
                          <td id=""><span id="msh"></span> মিনিট</td>
                          <td id=""><span id="mif"></span> মিনিট</td>
                        </tr>
                      </table>
                    </div>
                  </div>
            ...
            <div class="culture-banner-1">
              ...
              <ins class="adsbygoogle" style="display:inline-block;width:300px;height:250px"
                data-ad-client="ca-pub-5219299595808889" data-ad-slot="8097374499"></ins>
              <script>
              (adsbygoogle = window.adsbygoogle || []).push({});
              </script>
            </div>
            <!-- <div class="culture-banner-2">
            <img class="img-fluid" src="media/common/side-banner.gif" alt="Sports Banner">
          </div> -->
                ...
                <div class="tab-content new-page-style-3" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                    ...
                    <div class="latest-news">
                      <ul class="latest-news-ul" style="max-height: 500px;">
    ...
    <a href="https://www.ekusheysangbad.com/entertainment/news/342100">
      ...
      <div class="latest-news-right">
        <h3>শিল্পী সমিতি থেকে পদত্যাগ করলেন রোজিনা</h3>
            ...
            <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
            <div class="sports-banner-2">
              <script async="" src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
              <!-- Home_3_300x250 -->
              <ins class="adsbygoogle" style="display:inline-block;width:300px;height:250px" data-ad-client="ca-pub-5219299595808889" data-ad-slot="2652324743" data-adsbygoogle-status="done" data-ad-status="filled"><ins id="aswift_3_expand" style="display:inline-table;border:none;height:250px;margin:0;padding:0;position:relative;visibility:visible;width:300px;background-color:transparent;" tabindex="0" title="Advertisement" aria-label="Advertisement"><ins id="aswift_3_anchor" style="display:block;border:none;height:250px;margin:0;padding:0;position:relative;visibility:visible;width:300px;background-color:transparent;"><iframe id="aswift_3" name="aswift_3" style="left:0;position:absolute;top:0;border:0;width:300px;height:250px;" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" width="300" height="250" frameborder="0" src="https://googleads.g.doubleclick.net/pagead/ads?client=ca-pub-5219299595808889&amp;output=html&amp;h=250&amp;slotname=2652324743&amp;adk=832911585&amp;adf=1213704313&amp;pi=t.ma~as.2652324743&amp;w=300&amp;lmt=1625030632&amp;psa=1&amp;format=300x250&amp;url=https%3A%2F%2Fwww.ekusheysangbad.com%2F&amp;flash=0&amp;wgl=1&amp;uach=WyJXaW5kb3dzIiwiMTAuMCIsIng4NiIsIiIsIjkxLjAuNDQ3Mi4xMjQiLFtdLG51bGwsbnVsbCxudWxsXQ..&amp;tt_state=W3siaXNzdWVyT3JpZ2luIjoiaHR0cHM6Ly9hZHNlcnZpY2UuZ29vZ2xlLmNvbSIsInN0YXRlIjoyfSx7Imlzc3Vlck9yaWdpbiI6Imh0dHBzOi8vYXR0ZXN0YXRpb24uYW5kcm9pZC5jb20iLCJzdGF0ZSI6N31d&amp;dt=1625030630579&amp;bpp=4&amp;bdt=802&amp;idt=1932&amp;shv=r20210628&amp;ptt=9&amp;saldr=aa&amp;abxe=1&amp;cookie=ID%3D5ffc7ca419649a6f-229e309e92c7006b%3AT%3D1619255033%3ART%3D1619255033%3AS%3DALNI_MYzkHUBxC6-v0IXJUo-n6pyt5wspQ&amp;prev_fmts=0x0&amp;nras=1&amp;correlator=1080696461375&amp;frm=20&amp;pv=2&amp;ga_vid=307422339.1619255032&amp;ga_sid=1625030631&amp;ga_hid=627541978&amp;ga_fc=0&amp;u_tz=360&amp;u_his=2&amp;u_java=0&amp;u_h=768&amp;u_w=1366&amp;u_ah=768&amp;u_aw=1302&amp;u_cd=24&amp;u_nplug=3&amp;u_nmime=4&amp;adx=950&amp;ady=3832&amp;biw=1285&amp;bih=474&amp;scr_x=0&amp;scr_y=3400&amp;eid=21067496%2C31061661&amp;oid=3&amp;pvsid=3450577400022956&amp;pem=888&amp;ref=https%3A%2F%2Fwww.ekusheysangbad.com%2F&amp;eae=0&amp;fc=1920&amp;brdim=0%2C0%2C0%2C0%2C1302%2C0%2C1302%2C768%2C1302%2C474&amp;vis=1&amp;rsz=%7C%7CeE%7C&amp;abl=CS&amp;pfx=0&amp;fu=0&amp;bc=31&amp;ifi=4&amp;uci=a!4&amp;fsb=1&amp;xpc=Pu0JIBinzZ&amp;p=https%3A//www.ekusheysangbad.com&amp;dtd=1971" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no" allowfullscreen="true" allow="conversion-measurement" data-google-container-id="a!4" data-google-query-id="CJmW5OzOvvECFcHDfAodyAkOTQ" data-load-complete="true"></iframe></ins></ins></ins>
              <script>
              (adsbygoogle = window.adsbygoogle || []).push({});
              </script>
            </div>
      ...
      <div class="row custom-row">
        <div class="col-md-12 custom-padding">
          <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
          <!-- Home_full_width_1 -->
          <ins class="adsbygoogle" style="display:inline-block;width:1200px;height:90px"
            data-ad-client="ca-pub-5219299595808889" data-ad-slot="6919374792"></ins>
          <script>
          (adsbygoogle = window.adsbygoogle || []).push({});
          </script>
        </div>
  ...
  <section class="video-gallery-section">
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="video-gallery-left">
          <div class="col-md-12 custom-padding">
            <div class="video-lead-wrapper">
              <div class="video-lead-wrapper-title">
                <h2><a href="#"> প্রতি মুহূর্তের বাংলাদেশ </a></h2>
              </div>
              <!--/.video-lead-wrapper-title-->
              <div class="video-lead-wrapper-news">
                <a href="https://www.ekusheysangbad.com/video/145">
          <div class="video-lead-wrapper-image">
            <i class="fa fa-play"></i>
            <img class="img-fluid" src="https://www.ekusheysangbad.com/media/PhotoAlbum/2020October/mqdefault-20210806182811.webp" alt="পরিমনির বিরুদ্ধে যেসব অভিযোগ জানালো র‌্যাব">
          </div>
          <div class="video-lead-wrapper-text">
            <h2>পরিমনির বিরুদ্ধে যেসব অভিযোগ জানালো র‌্যাব</h3>
          </div>
        </a>              </div>
              <!--/.video-lead-wrapper-news-->
            </div>
            <!--/.video-lead-wrapper-->
          </div>
          <!--/.col-md-12-->
        ...
        <div class="video-gallery-right">
          <div class="col-md-12 custom-padding">

            <nav class="nav-video-tab-option">
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab"
                  aria-controls="nav-home" aria-selected="true"> সংবাদ </a>
                <a class="nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
                  aria-controls="nav-profile" aria-selected="false"> ফিচার </a>
                <a class="nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab"
                  aria-controls="nav-contact" aria-selected="false"> ফেসবুক লাইভ </a>
              </div>
            </nav>
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              <div class="tab-pane fade show active new-fade" id="nav-home" role="tabpanel"
                aria-labelledby="nav-home-tab">
                <div id="featured-videos-news" class="owl-carousel">
                  <div class="item">
          <a href="https://www.ekusheysangbad.com/video/149">
              ...
              <div class="videos-text">
                <h3>কি কারনে পরীমনির জামিন নামঞ্জুর, বক্তব্যে রাষ্ট্র পক্ষের আইনজীবী.....</h3>
              </div>
          </a>
        </div><div class="item">
          <a href="https://www.ekusheysangbad.com/video/148">
              ...
              <div class="videos-text">
                <h3>পরীমনির জামিন নামঞ্জুর বক্তব্য আইনজীবীর....</h3>
              </div>
          </a>
        </div><div class="item">
          <a href="https://www.ekusheysangbad.com/video/147">
              ...
              <div class="videos-text">
                <h3>ঈদ পরবর্তী কঠোর লকডাউনের ১৯তম শেষ দিনে রাজধানী জিরো পয়েন্টের ভিডিও চিএ....</h3>
              </div>
          </a>
        </div><div class="item">
          <a href="https://www.ekusheysangbad.com/video/146">
              ...
              <div class="videos-text">
                <h3>চীফ মেট্রোপলিটন ম‍্যাজিস্ট্রেট কোট থেকে পরীমনির আইনজীবীর বক্তব্য সরাসরি..</h3>
              </div>
          </a>
        </div><div class="item">
          <a href="https://www.ekusheysangbad.com/video/144">
              ...
              <div class="videos-text">
                <h3>কোরবানীর গরু নিয়ে দিশেহারা খামারীরা</h3>
              </div>
          </a>
        </div><div class="item">
          ...
          <a href="https://www.ekusheysangbad.com/video/39">
              ...
              <div class="tab-pane fade new-fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
        ...
        <a href="https://www.ekusheysangbad.com/video/94">
            ...
            <div class="videos-text">
              <h3>গানাড্ডা উইথ রোমান মাজহার</h3>
            </div>
        </a>
      </div>                </div>
                <!--/featured-videos-section-->
              ...
              <div class="tab-pane fade new-fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                <div id="facebook-videos-news" class="owl-carousel">
                  <div class="item">
        <a href="https://www.ekusheysangbad.com/video/133">
            ...
            <div class="videos-text">
              <h3>একুশে সংবাদ.কম অনলাইন স্বাস্থ্য বুলেটিন (৩০/১২/২০২০)</h3>
            </div>
        </a>
      </div><div class="item">
        <a href="https://www.ekusheysangbad.com/video/129">
            ...
            <div class="videos-text">
              <h3>একুশে সংবাদ.কম অনলাইন স্বাস্থ্য বুলেটিন (২৮/১২/২০২০)</h3>
            </div>
        </a>
      </div><div class="item">
        <a href="https://www.ekusheysangbad.com/video/127">
            ...
            <div class="videos-text">
              <h3>একুশে সংবাদ.কম অনলাইন স্বাস্থ্য বুলেটিন (২৭/১২/২০২০)</h3>
            </div>
        </a>
      </div><div class="item">
        <a href="https://www.ekusheysangbad.com/video/125">
            ...
            <div class="videos-text">
              <h3>একুশে সংবাদ.কম অনলাইন স্বাস্থ্য বুলেটিন (২৬/১২/২০২০)</h3>
            </div>
        </a>
      </div><div class="item">
        <a href="https://www.ekusheysangbad.com/video/123">
            ...
            <div class="videos-text">
              <h3>একুশে সংবাদ.কম অনলাইন স্বাস্থ্য বুলেটিন (২১/১২/২০২০)</h3>
            </div>
        </a>
      </div><div class="item">
        <a href="https://www.ekusheysangbad.com/video/121">
            ...
            <div class="videos-text">
              <h3>একুশে সংবাদ.কম অনলাইন স্বাস্থ্য বুলেটিন (২০/১২/২০২০)</h3>
            </div>
        </a>
      </div><div class="item">
        <a href="https://www.ekusheysangbad.com/video/118">
            ...
            <div class="videos-text">
              <h3>একুশে সংবাদ.কম অনলাইন স্বাস্থ্য বুলেটিন (১৯/১২/২০২০)</h3>
            </div>
        </a>
      </div><div class="item">
        <a href="https://www.ekusheysangbad.com/video/116">
            ...
            <div class="videos-text">
              <h3>একুশে সংবাদ.কম অনলাইন স্বাস্থ্য বুলেটিন (১৭/১২/২০২০)</h3>
            </div>
        </a>
      </div>                </div>
                <!--/featured-videos-section-->
            ...
            <div class="all-video-wrapper-text">
              <a href="https://www.ekusheysangbad.com/video" class="all-videos" rel="nofollow">সকল ভিডিও দেখুন <i
  ...
  <section class="national-news-wrapper">
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="national-news-wrapper-left new-national-news-wrapper-style">
          <div class="col-md-12 custom-padding">
            <div class="new-heading-title">
              <h3><a href="https://www.ekusheysangbad.com/national"><span> জাতীয় </span></a></h3>
            </div>
            <div class="row custom-row">
...
মঙ্গলবার (১ মার্চ) ডেমরা থানার ভারপ্রাপ্ত কর্মকর্তা (ওসি) মো.</p>
              </div>
            </a>
          </div>
        </div>
        <div class="col-md-12 col-lg-7 custom-padding">
            <div class="row custom-row">
            <div class="col-12 col-md-6">
      <ul class="national-news-list">
      ...
      <li>
            ...
            <div class="national-news-left">
              ...
              <h3>বাংলাদেশ-ভারত সম্পর্ক ঐতিহাসিক: সংস্কৃতি প্রতিমন্ত্রী</h3>
              </div>
            </a>
            </li>
      ...
      <li>
            ...
            <div class="national-news-left">
              ...
              <h3>বঙ্গবন্ধুর প্রতিকৃতিতে নতুন ইসির শ্রদ্ধা</h3>
              </div>
            </a>
            </li>
      ...
      <li>
            ...
            <div class="national-news-left">
              ...
              <h3>শেখ রাসেল জাতীয় শিশু কিশোর পরিষদের প্রতিষ্ঠাবার্ষিকীতে ক্রীড়া সামগ্রী বিতরণ </h3>
              </div>
            </a>
            </li>
      ...
      <li>
            ...
            <div class="national-news-left">
              ...
              <h3>দুঃসময়ে যারা দলের পাশে থাকে তারাই প্রকৃত বন্ধু: ওবায়দুল কাদের</h3>
              </div>
            </a>
            </li>
      ...
      <li>
            ...
            <div class="national-news-left">
              ...
              <h3>চন্দনকোঠা ও নগর ভবনের সম্মুখে অভিযান; ৩৫ শতক জমি উদ্ধার </h3>
              </div>
            </a>
            </li>
      ...
      <li>
            ...
            <div class="national-news-left">
              ...
              <h3>দেশের কোথাও ভিক্ষুক দেখা যায় না-তথ্যমন্ত্রী</h3>
              </div>
            </a>
            </li>
      ...
      <li>
            ...
            <div class="national-news-left">
              ...
              <h3>পাপুলের স্ত্রী-কন্যার ব্যাংক হিসাবের তথ্য চায় দুদক</h3>
              </div>
            </a>
            </li>
  ...
  <section class="feature-news-wrapper feature-news-top-wrapper">
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/politics"><span class="text-span"> রাজনীতি </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
            ...
            <li>
              <a href="https://www.ekusheysangbad.com/politics/news/343467">
                <div class="feature-news-single">
                  ...
                  <h3>ডা. জাফরুল্লাহর সাথে বিএনপির কোনো সম্পর্ক নেই-ফখরুল </h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/politics/news/343462">
                <div class="feature-news-single">
                  ...
                  <h3>বিএনপি একটি বিচ্ছিন্ন রাজনৈতিক দল : ওবায়দুল কাদের</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/politics/news/343384">
                <div class="feature-news-single">
                  ...
                  <h3>বিএনপি নির্বাচন কমিশন চায় না, নির্বাচনও চায় না: কৃষিমন্ত্রী</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/politics/news/343382">
                <div class="feature-news-single">
                  ...
                  <h3>আন্দোলন সংগ্রামের কোনো বিকল্প নেই: ফখরুল</h3>
                  </div>
                </div>
              </a>
            </li>        </div>
        ...
        <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
            <a href="https://www.ekusheysangbad.com/international"><span class="text-span"> আন্তর্জাতিক </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
            ...
            <li>
              <a href="https://www.ekusheysangbad.com/international/news/343523">
                <div class="feature-news-single">
                  ...
                  <h3>জাতিসংঘের ১২ রুশ কূটনীতিককে বহিষ্কার করল যুক্তরাষ্ট্র</h3>
                  </div>
                </div>
              </a>
            </li>
            ...
            <li>
              <a href="https://www.ekusheysangbad.com/international/news/343520">
                <div class="feature-news-single">
                  ...
                  <h3>ভারতীয় শিক্ষার্থীদের সীমান্ত পেরোতে ইউক্রেন সৈন্যের বাধা</h3>
                  </div>
                </div>
              </a>
            </li>        </div>
        ...
        <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/health"><span class="text-span"> স্বাস্থ্য </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
            ...
            <li>
              <a href="https://www.ekusheysangbad.com/health/news/343500">
                <div class="feature-news-single">
                  ...
                  <h3>যুক্তরাষ্ট্র থেকে সর্বোচ্চ টিকা পেয়েছে বাংলাদেশ</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/health/news/343481">
                <div class="feature-news-single">
                  ...
                  <h3>তামাকজনিত রোগে বছরে দেড় লক্ষাধিক মানুষের মৃত্যু</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/health/news/343460">
                <div class="feature-news-single">
                  ...
                  <h3>করোনায় আরও ৪ জনের মৃত্যু</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/health/news/343356">
                <div class="feature-news-single">
                  ...
                  <h3>একদিনে রেকর্ড এক কোটি ২০ লাখ টিকা দেয়া হয়েছে-স্বাস্থ্যমন্ত্রী</h3>
                  </div>
                </div>
              </a>
            </li>        </div>
    ...
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="sports-left">
          <div class="col-md-12 custom-padding">
            <nav class="nav-video-tab-option tab-section-option">
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <div class="nav-title">
                <a href="https://www.ekusheysangbad.com/sports">
                  <h3>খেলাধুলা</h3>
                </a>
              </div>
                <a class="nav-link active show" id="nav-all-tab" data-toggle="tab" href="#nav-all" role="tab" aria-controls="nav-all" aria-selected="true"> সকল </a>
                <a class="nav-link" id="nav-cricket-tab" data-toggle="tab" href="#nav-cricket" role="tab" aria-controls="nav-cricket" aria-selected="true">ক্রিকেট</a>
                <a class="nav-link" id="nav-football-tab" data-toggle="tab" href="#nav-football" role="tab" aria-controls="nav-football" aria-selected="false">ফুটবল</a>
                <a class="nav-link" id="nav-other-tab" data-toggle="tab" href="#nav-other" role="tab" aria-controls="nav-other" aria-selected="false">অনান্য</a>

              </div>
          </nav>
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade new-fade active show" id="nav-all" role="tabpanel" aria-labelledby="nav-all-tab">
              <div class="row custom-row">
                <div class="col-md-12 col-lg-3 custom-padding">
                  <div class="row custom-row">
              <div class="col-md-6 col-lg-12 custom-padding">
            ...
            </div><div class="col-md-12 col-lg-6 custom-padding">
                    <div class="new-style-sports-big">
                      <a href="https://www.ekusheysangbad.com/sports/news/343539">
                        ...
                        <div class="new-style-sports-big-text">
                          ...
                          <h2>নিজেদের উন্নতি বিশ্বকে দেখানোর এটাই সেরা সুযোগ-নিগার</h2>
                        </div>
                      </a>
                    </div>
                  </div>
            ...
            <div class="col-md-6 col-lg-12 custom-padding">
                    ...
                    <a href="https://www.ekusheysangbad.com/sports/news/343494">
                        ...
                        <h3>দ. আফ্রিকায় টেস্ট খেলবেন সাকিব</h3>
                        </div>
                      </a>
                    </div>
                  </div>
            ...
            <div class="col-md-6 col-lg-12 custom-padding">
                    ...
                    <a href="https://www.ekusheysangbad.com/sports/news/343470">
                        ...
                        <h3>আফগানদের সাথে ১০ পয়েন্ট হারাল বাংলাদেশ</h3>
                        </div>
                      </a>
                    </div>
                  </div>
          ...
          <div class="new-style-sports-small">
            <a href="https://www.ekusheysangbad.com/sports/news/343468">
              ...
              <div class="new-style-sports-small-text">
                ...
                <h3>ব্যাডমিন্টনে অ্যাডহক কমিটি</h3>
              </div>
            </a>
          </div>
        </div>
          ...
          <div class="new-style-sports-small">
            <a href="https://www.ekusheysangbad.com/sports/news/343466">
              ...
              <div class="new-style-sports-small-text">
                ...
                <h3>শেখ রাসেলকে হারিয়ে শীর্ষে উঠল বসুন্ধরা কিংস</h3>
              </div>
            </a>
          </div>
        </div>
          ...
          <div class="new-style-sports-small">
            <a href="https://www.ekusheysangbad.com/sports/news/343463">
              ...
              <div class="new-style-sports-small-text">
                ...
                <h3>আফগান সিরিজ শেষে সাকিবের সঙ্গে বসবে বিসিবি</h3>
              </div>
            </a>
          </div>
        </div>
          ...
          <div class="new-style-sports-small">
            <a href="https://www.ekusheysangbad.com/sports/news/343431">
              ...
              <div class="new-style-sports-small-text">
                ...
                <h3>টস জিতে ব্যাটিংয়ে বাংলাদেশ</h3>
              </div>
            </a>
          </div>
        </div>
          </div>            </div>
            <div class="tab-pane fade new-fade" id="nav-cricket" role="tabpanel" aria-labelledby="nav-cricket-tab">
              <div class="row custom-row">
                <div class="col-md-12 col-lg-3 custom-padding">
                  <div class="row custom-row"><div class="col-md-6 col-lg-12 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343470">
                  <div class="new-style-sports-small-image">
                    <img src="https://www.ekusheysangbad.com/media/imgAll/2022January/SM/Untitled-9-20220228122303.jpg" class="img-fluid" alt="আফগানদের সাথে ১০ পয়েন্ট হারাল বাংলাদেশ" />
            ...
            </div><div class="col-md-6 col-lg-12 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343463">
                  <div class="new-style-sports-small-image">
                    <img src="https://www.ekusheysangbad.com/media/imgAll/2022January/SM/Untitled-3-20220228115127.jpg" class="img-fluid" alt="আফগান সিরিজ শেষে সাকিবের সঙ্গে বসবে বিসিবি" />
                  ...
                  </div><div class="col-md-12 col-lg-3 custom-padding">
                <div class="row custom-row"><div class="col-md-6 col-lg-12 custom-padding">
                    <div class="new-style-sports-small">
                      <a href="https://www.ekusheysangbad.com/sports/news/343431">
                        <div class="new-style-sports-small-image">
                    ...
                    <div class="new-style-sports-small">
                      <a href="https://www.ekusheysangbad.com/sports/news/343419">
                        ...
                        <div class="new-style-sports-small-text">
                          ...
                          <h3>পিএসএলের শিরোপা আফ্রিদির লাহোরের</h3>
                        </div>
                      </a>
                    </div>
                  </div></div>
            </div>
            </div><div class="row custom-row"><div class="col-md-3 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343357">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>প্রথম বিশ্বকাপ স্মরণীয় করে রাখতে চান বাংলাদেশের মেয়েরা</h3>
                  </div>
                </a>
              </div>
              ...
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343309">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>বগুড়ায় অনুশীলন ক্যাম্পে মুমিনুল-সৌম্যরা</h3>
                  </div>
                </a>
              </div>
            </div><div class="col-md-3 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343237">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>ব্রাজিল ক্লাবের টিম বাসে বিস্ফোরণ, আহত ৩ ফুটবলার</h3>
                  </div>
                </a>
              </div>
            </div><div class="col-md-3 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343213">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>আফগানদের গুড়িয়ে ওয়ানডে সিরিজ জিতল টাইগাররা</h3>
                  </div>
                </a>
              </div>
            </div></div>            </div>
            <div class="tab-pane fade new-fade" id="nav-football" role="tabpanel" aria-labelledby="nav-football-tab">
              <div class="row custom-row">
                <div class="col-md-12 col-lg-3 custom-padding">
                  <div class="row custom-row"><div class="col-md-6 col-lg-12 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343416">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>রাশিয়ায় সব আন্তর্জাতিক ম্যাচ নিষিদ্ধ</h3>
                  </div>
                </a>
              </div>
            </div><div class="col-md-6 col-lg-12 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343415">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>বিলবাওকে গুঁড়িয়ে বার্সেলোনার বড় জয়</h3>
                  </div>
                </a>
              </div>
            </div></div>
                      ...
                      <a href="https://www.ekusheysangbad.com/sports/news/343466">
                        <div class="new-style-sports-big-image">
                          ...
                          <div class="new-style-sports-big-text">
                            ...
                            <h2>শেখ রাসেলকে হারিয়ে শীর্ষে উঠল বসুন্ধরা কিংস</h2>
                          </div>
                        </a>
                    </div>
                  </div><div class="col-md-12 col-lg-3 custom-padding">
                    ...
                    <div class="new-style-sports-small">
                      <a href="https://www.ekusheysangbad.com/sports/news/343414">
                        ...
                        <div class="new-style-sports-small-text">
                          ...
                          <h3>টাইব্রেকারে চেলসিকে হারিয়ে লিভারপুলের শিরোপা</h3>
                        </div>
                      </a>
                    </div>
                  </div><div class="col-md-6 col-lg-12 custom-padding">
                    <div class="new-style-sports-small">
                      <a href="https://www.ekusheysangbad.com/sports/news/343365">
                        ...
                        <div class="new-style-sports-small-text">
                          ...
                          <h3>প্যারিসে ‘জাদু’ দেখিয়েই মেসি ফিরলেন বার্সেলোনায়</h3>
                        </div>
                      </a>
                    </div>
                  </div></div>
              ...
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343318">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>আবারও রোনালদোর ইউনাইটেডের হোঁচট</h3>
                  </div>
                </a>
              </div>
            </div><div class="col-md-3 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343317">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>এভারটনের বিপক্ষে সিটির ঘাম ঝরানো জয়</h3>
                  </div>
                </a>
              </div>
            </div><div class="col-md-3 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343316">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>ভাইয়েকানোর মাঠে রিয়ালের কষ্টার্জিত জয়</h3>
                  </div>
                </a>
              </div>
            </div><div class="col-md-3 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343315">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>মেসি-এমবাপের ঝলকে পিএসজির বড় জয়</h3>
                  </div>
                </a>
              </div>
            </div></div>            </div>
            <div class="tab-pane fade new-fade" id="nav-other" role="tabpanel" aria-labelledby="nav-other-tab">
              <div class="row custom-row">
                <div class="col-md-12 col-lg-3 custom-padding">
                  <div class="row custom-row"><div class="col-md-6 col-lg-12 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343394">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>কক্সবাজারের ‘সাম্পানে’ ঠাই পাচ্ছে হকিও </h3>
                  </div>
                </a>
              </div>
            </div><div class="col-md-6 col-lg-12 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/343360">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>ইউক্রেন যুদ্ধের জেরে চেলসির ‘দায়িত্ব’ ছাড়লেন আব্রামোভিচ</h3>
                  </div>
                </a>
              </div>
            </div></div>
                      ...
                      <a href="https://www.ekusheysangbad.com/sports/news/343468">
                        <div class="new-style-sports-big-image">
                          ...
                          <div class="new-style-sports-big-text">
                            ...
                            <h2>ব্যাডমিন্টনে অ্যাডহক কমিটি</h2>
                          </div>
                        </a>
                    </div>
                  </div><div class="col-md-12 col-lg-3 custom-padding">
                    ...
                    <div class="new-style-sports-small">
                      <a href="https://www.ekusheysangbad.com/sports/news/343282">
                        ...
                        <div class="new-style-sports-small-text">
                          ...
                          <h3>বগুড়ায় আন্তর্জাতিক ম্যাচ না হওয়ার ব্যাখ্যা দিল বিসিবি</h3>
                        </div>
                      </a>
                    </div>
                  </div><div class="col-md-6 col-lg-12 custom-padding">
                    <div class="new-style-sports-small">
                      <a href="https://www.ekusheysangbad.com/sports/news/343177">
                        ...
                        <div class="new-style-sports-small-text">
                          ...
                          <h3>জাতীয় যুব র‍্যাঙ্কিং আরচ্যারিতে রেকর্ড</h3>
                        </div>
                      </a>
                    </div>
                  </div></div>
              ...
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/342962">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>ভক্তদের ভালো বাসায় সিক্ত জোকোভিচ  ফিরেছেন কোর্টে</h3>
                  </div>
                </a>
              </div>
            </div><div class="col-md-3 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/342927">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>শেষ হলো সেনাবাহিনী হকি প্রতিযোগিতা</h3>
                  </div>
                </a>
              </div>
            </div><div class="col-md-3 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/342751">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>জমকালো আয়োজনে অনুষ্ঠিত হলো বাংলার মুষ্টিবাজ</h3>
                  </div>
                </a>
              </div>
            </div><div class="col-md-3 custom-padding">
              <div class="new-style-sports-small">
                <a href="https://www.ekusheysangbad.com/sports/news/342638">
                  ...
                  <div class="new-style-sports-small-text">
                    ...
                    <h3>রেস্টুরেন্ট ব্যবসায় খালেদ মাসুদ পাইলট</h3>
                  </div>
                </a>
              </div>
            </div></div>            </div>
  ...
  <section class="feature-news-wrapper">
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/information-technology"><span class="text-span"> তথ্য-প্রযুক্তি
                </span></a>
              <span class="liner"></span>
            </h2>
          </div>
            ...
            <li>
              <a href="https://www.ekusheysangbad.com/information-technology/news/343478">
                <div class="feature-news-single">
                  ...
                  <h3>৬ ভিন্ন রঙে আসছে মারুতি সুজুকির ব্যালেনো</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/information-technology/news/343427">
                <div class="feature-news-single">
                  ...
                  <h3>অব্যবহৃত ডেটা যোগ হবে নতুন প্যাকেজে</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/information-technology/news/343389">
                <div class="feature-news-single">
                  ...
                  <h3>যে ৩ টিপস মানলে আপনার স্মার্টফোন হ্যাং হবে না</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/information-technology/news/343162">
                <div class="feature-news-single">
                  ...
                  <h3>হোয়াটসঅ্যাপে যে ৯ ভুল কখনই করবেন না</h3>
                  </div>
                </div>
              </a>
            </li>        </div>
        ...
        <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/crime"><span class="text-span"> অপরাধ </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
            ...
            <li>
              <a href="https://www.ekusheysangbad.com/crime/news/343417">
                <div class="feature-news-single">
                  ...
                  <h3>মোহাম্মদপুরের শীর্ষ সন্ত্রাসী মোশারফ আটক</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/crime/news/343408">
                <div class="feature-news-single">
                  ...
                  <h3>চাকরির নামে প্রতারণা যুবকক আটক</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/crime/news/343381">
                <div class="feature-news-single">
                  ...
                  <h3>শরণখোলায় তিন নারী ছিনতাইকারীকে আটক</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/crime/news/343373">
                <div class="feature-news-single">
                  ...
                  <h3>ডিমলায় হেরোইন ও ইয়াবাসহ মাদক ব্যবসায়ী গ্রেফতার</h3>
                  </div>
                </div>
              </a>
            </li>        </div>
        ...
        <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/lifestyle"><span class="text-span"> লাইফস্টাইল </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
            ...
            <li>
              <a href="https://www.ekusheysangbad.com/lifestyle/news/343485">
                <div class="feature-news-single">
                  ...
                  <h3>লাচ্ছা পরোটা তৈরির রেসিপি</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/lifestyle/news/343483">
                <div class="feature-news-single">
                  ...
                  <h3>যে ভুলে আপনার ওজন অতিরিক্ত বেড়ে যেতে পারে</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.ekusheysangbad.com/lifestyle/news/343426">
                <div class="feature-news-single">
                  ...
                  <h3>পায়ের গোড়ালি ফাটা ৪ রোগের লক্ষণ</h3>
                  </div>
                </div>
              </a>
            </li>        </div>
      ...
      <!--/.row-->
      <div class="row custom-row">
        <div class="col-sm-12 custom-padding" style="padding-top:15px;">
          <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
          <!-- Home_full_width_1 -->
          <ins class="adsbygoogle" style="display:inline-block;width:1200px;height:90px"
            data-ad-client="ca-pub-5219299595808889" data-ad-slot="6919374792"></ins>
  ...
  <!--/.feature-news-wrapper-->
  <section class="tab-news-wrapper">
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-6 custom-padding">
          <nav class="nav-video-tab-option tab-news-option">
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <div class="nav-title">
                <a href="#">
                  <h3>অর্থ-বাণিজ্য</h3>
              ...
              <a style="padding: 3px 5px;" class="nav-link active show" id="nav-all-tab" data-toggle="tab" href="#nav-all" role="tab" aria-controls="nav-all" aria-selected="true"> সকল </a>
              <a style="padding: 3px 5px;" class="nav-link" id="nav-bank-tab" data-toggle="tab" href="#nav-bank" role="tab" aria-controls="nav-bank" aria-selected="true"> ব্যাংক </a>
              <a style="padding: 3px 5px;" class="nav-link" id="nav-insurance-tab" data-toggle="tab" href="#nav-insurance" role="tab" aria-controls="nav-insurance" aria-selected="false"> বীমা </a>
              <a style="padding: 3px 5px;" class="nav-link" id="nav-corporate-tab" data-toggle="tab" href="#nav-corporate" role="tab" aria-controls="nav-corporate" aria-selected="false"> কর্পোরেট </a>
              <a style="padding: 3px 5px;" class="nav-link" id="nav-market-tab" data-toggle="tab" href="#nav-market" role="tab" aria-controls="nav-market" aria-selected="false"> শেয়ার বাজার </a>
            </div>
          </nav>
          <!--/.nav-video-tab-option-->
          ...
          <div class="tab-pane fade new-fade active show" id="nav-all" role="tabpanel" aria-labelledby="nav-all-tab">
              ...
              <div class="col-md-5 custom-padding">
                <div class="row custom-row"><div class="col-md-12 custom-padding">
            ...
            </div><div class="col-md-12 custom-padding">
              <div class="tab-news-block for-video-icon">
            ...
            </div><div class="col-md-7 custom-padding">
                <ul class="feature-news-ul tab-news-ul">
            <li>
            ...
            <div class="tab-pane fade new-fade" id="nav-bank" role="tabpanel" aria-labelledby="nav-bank-tab">
              <div class="row custom-row">
            ...
            <div class="tab-pane fade new-fade" id="nav-insurance" role="tabpanel" aria-labelledby="nav-insurance-tab">
              <div class="row custom-row">
            ...
            <div class="tab-pane fade new-fade" id="nav-corporate" role="tabpanel" aria-labelledby="nav-corporate-tab">
              <div class="row custom-row">
            ...
            <div class="tab-pane fade new-fade" id="nav-market" role="tabpanel" aria-labelledby="nav-market-tab">
              <div class="row custom-row">
        ...
        <div class="col-md-6 custom-padding">
          <nav class="nav-video-tab-option tab-news-option">
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <div class="nav-title nav-title-2">
                <a href="#">
                  <h3>প্রবাস</h3>
                </a>
              </div>
              <a class="nav-link active show" id="nav-all-pro-tab" data-toggle="tab" href="#nav-all-pro" role="tab" aria-controls="nav-all-pro" aria-selected="true"> সকল </a>
              <a class="nav-link" id="nav-us-tab" data-toggle="tab" href="#nav-us" role="tab" aria-controls="nav-us" aria-selected="true">  আমেরিকা </a>
              <a class="nav-link" id="nav-uk-tab" data-toggle="tab" href="#nav-uk" role="tab" aria-controls="nav-uk" aria-selected="false"> লন্ডন </a>
              <a class="nav-link" id="nav-aus-tab" data-toggle="tab" href="#nav-aus" role="tab" aria-controls="nav-aus" aria-selected="false"> অস্ট্রেলিয়া </a>
              <a class="nav-link" id="nav-ger-tab" data-toggle="tab" href="#nav-ger" role="tab" aria-controls="nav-ger" aria-selected="false"> জার্মানি </a>
              <a class="nav-link" id="nav-fra-tab" data-toggle="tab" href="#nav-fra" role="tab" aria-controls="nav-fra" aria-selected="false"> ফ্রান্স </a>
              <a class="nav-link" id="nav-italy-tab" data-toggle="tab" href="#nav-italy" role="tab" aria-controls="nav-italy" aria-selected="false"> 	ইতালি </a>
            </div>
          </nav>
          <!--/.nav-video-tab-option-->
          ...
          <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade new-fade active show" id="nav-all-pro" role="tabpanel" aria-labelledby="nav-all-pro-tab">
            <div class="row custom-row">
            <div class="col-md-5 custom-padding">
                <div class="row custom-row"><div class="col-md-12 custom-padding">
              <div class="tab-news-block for-video-icon">
            ...
            <div class="tab-pane fade new-fade" id="nav-us" role="tabpanel" aria-labelledby="nav-us-tab">
              <div class="row custom-row">
                <div class="col-md-5 custom-padding">
                <div class="row custom-row"><div class="col-md-12 custom-padding">
              <div class="tab-news-block for-video-icon">
            ...
            <div class="tab-pane fade new-fade" id="nav-uk" role="tabpanel" aria-labelledby="nav-uk-tab">
              <div class="row custom-row">
              <div class="col-md-5 custom-padding">
                <div class="row custom-row"><div class="col-md-12 custom-padding">
              <div class="tab-news-block for-video-icon">
            ...
            <div class="tab-pane fade new-fade" id="nav-aus" role="tabpanel" aria-labelledby="nav-aus-tab">
              <div class="row custom-row">
              <div class="col-md-5 custom-padding">
                <div class="row custom-row"><div class="col-md-12 custom-padding">
              <div class="tab-news-block for-video-icon">
            ...
            <!--/.tab-pane-->
            <div class="tab-pane fade new-fade" id="nav-ger" role="tabpanel" aria-labelledby="nav-ger-tab">
              <div class="row custom-row">
              <div class="col-md-5 custom-padding">
                <div class="row custom-row"><div class="col-md-12 custom-padding">
              <div class="tab-news-block for-video-icon">
            ...
            <!--/.tab-pane-->
            <div class="tab-pane fade new-fade" id="nav-fra" role="tabpanel" aria-labelledby="nav-fra-tab">
              <div class="row custom-row">
                            </div>
            </div>
            <!--/.tab-pane-->
            <div class="tab-pane fade new-fade" id="nav-italy" role="tabpanel" aria-labelledby="nav-italy-tab">
              <div class="row custom-row">
              <div class="col-md-5 custom-padding">
                <div class="row custom-row"><div class="col-md-12 custom-padding">
              <div class="tab-news-block for-video-icon">
  ...
  <section class="entertainment-wrapper">
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-12 custom-padding">
          <nav class="nav-video-tab-option tab-section-option2">
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <div class="nav-title">
                  <a href="#">
                    <h3>বিনোদন</h3>
                ...
                <a class="nav-link active show" id="nav-entire-tab" data-toggle="tab" href="#nav-entire" role="tab" aria-controls="nav-entire" aria-selected="true"> সকল </a>
                <a class="nav-link" id="nav-bollywood-tab" data-toggle="tab" href="#nav-bollywood" role="tab" aria-controls="nav-bollywood" aria-selected="false">বলিউড</a>
                <a class="nav-link" id="nav-hollywood-tab" data-toggle="tab" href="#nav-hollywood" role="tab" aria-controls="nav-hollywood" aria-selected="false">হলিউড</a>
                <a class="nav-link" id="nav-dhallywood-tab" data-toggle="tab" href="#nav-dhallywood" role="tab" aria-controls="nav-dhallywood" aria-selected="false">ঢালিউড</a>
                <a class="nav-link" id="nav-more-tab" data-toggle="tab" href="#nav-more" role="tab" aria-controls="nav-more" aria-selected="false">অনান্য</a>
              </div>
          </nav>
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade new-fade active show" id="nav-entire" role="tabpanel" aria-labelledby="nav-entire-tab">
        ...
        <div class="col-6 col-md-6 col-lg-3 custom-padding">
          <div class="entertainment-small">
            ...
            <div class="tab-pane fade new-fade" id="nav-bollywood" role="tabpanel" aria-labelledby="nav-bollywood-tab">
              <div class="row custom-row">
                <div class="col-12 col-md-12 col-lg-6 custom-padding">
                  <div class="entertainment-big">
            ...
            <div class="tab-pane fade new-fade" id="nav-hollywood" role="tabpanel" aria-labelledby="nav-hollywood-tab">
              <div class="row custom-row">
                <div class="col-12 col-md-12 col-lg-6 custom-padding">
                  <div class="entertainment-big">
                    <a href="https://www.ekusheysangbad.com/entertainment/news/343530">
            ...
            <div class="tab-pane fade new-fade" id="nav-dhallywood" role="tabpanel" aria-labelledby="nav-dhallywood-tab">
              <div class="row custom-row">
                <div class="col-12 col-md-12 col-lg-6 custom-padding">
                  <div class="entertainment-big">
                    <a href="https://www.ekusheysangbad.com/entertainment/news/343488">
            ...
            <div class="tab-pane fade new-fade" id="nav-more" role="tabpanel" aria-labelledby="nav-more-tab">
              <div class="row custom-row">
                <div class="col-12 col-md-12 col-lg-6 custom-padding">
                  <div class="entertainment-big">
  ...
  <section class="feature-news-wrapper">
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/education"><span class="text-span"> শিক্ষা </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
          ...
          <li>
            <a href="https://www.ekusheysangbad.com/education/news/343502">
              <div class="new-feature-news-single">
                ...
                <h3>প্রাথমিকের ক্লাস ২০ রমজান পর্যন্ত</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/education/news/343458">
              <div class="new-feature-news-single">
                ...
                <h3>দুই পাবলিক বিশ্ববিদ্যালয়ের অনুমোদন</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/education/news/343410">
              <div class="new-feature-news-single">
                ...
                <h3>এসএসসি পরীক্ষা জুনে , আগস্টে এইচএসসি পরীক্ষা</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/education/news/343379">
              <div class="new-feature-news-single">
                ...
                <h3>গবেষণা মঞ্জুরি আরও বাড়ানোর দাবি বিশ্ববিদ্যালয় পরিষদের</h3>
                </div>
              </div>
            </a>
          </li>        </div>
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/media-news"><span class="text-span">  গণমাধ্যম </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
          ...
          <div class="new-feature-lead">
            ...
            <li>
              ...
              <div class="new-feature-news-left">
                  ...
                  <h3>নানা আয়োজনে নোবিপ্রবি প্রেসক্লাবের ৩য় প্রতিষ্ঠাবার্ষিকী উদযাপন</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              ...
              <div class="new-feature-news-left">
                  ...
                  <h3>বাসসের এমডি পদে আবারও নিয়োগ পেলেন আবুল কালাম আজাদ</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              ...
              <div class="new-feature-news-left">
                  ...
                  <h3>ভাষা শহীদদের প্রতি ডিআরইউ’র শ্রদ্ধা</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              ...
              <div class="new-feature-news-left">
                  ...
                  <h3>ঠাকুরগাঁও সাংবাদিক ফোরামের কমিটি গঠন</h3>
                  </div>
                </div>
              </a>
            </li>        </div>
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/feature"><span class="text-span"> ফিচার </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
          ...
          <li>
            <a href="https://www.ekusheysangbad.com/feature/news/336526">
              <div class="new-feature-news-single">
                ...
                <h3>উলিপুরে শীতের আগমনী বার্তায় বেড়েছে লেপ তোষকের চাহিদা</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/feature/news/336007">
              <div class="new-feature-news-single">
                ...
                <h3>দারাজে শুরু হয়ে গেল বিগেস্ট ওয়ান ডে সেল</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/feature/news/335110">
              <div class="new-feature-news-single">
                ...
                <h3>অযত্নেই বিলুপ্তির পথে হরিপুরের রাজবাড়ি</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/feature/news/328264">
              <div class="new-feature-news-single">
                ...
                <h3>বয়ঃসন্ধি কালে যা যা লক্ষন দেখা যায়</h3>
                </div>
              </div>
            </a>
          </li>        </div>
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/campus"><span class="text-span"> ক্যাম্পাস </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
          ...
          <div class="new-feature-lead">
            ...
            <li>
              ...
              <div class="new-feature-news-left">
                  ...
                  <h3>৮ই মার্চ জবির প্রথম বর্ষের ক্লাস শুরু</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              ...
              <div class="new-feature-news-left">
                  ...
                  <h3>জবির ভর্তির অনিয়মে চরম ভোগান্তিতে শিক্ষার্থীরা</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              ...
              <div class="new-feature-news-left">
                  ...
                  <h3>ব‌শেমুর‌বিপ্রবি-‌তে মানববন্ধন</h3>
                  </div>
                </div>
              </a>
            </li>
            <li>
              ...
              <div class="new-feature-news-left">
                  ...
                  <h3>নোবিপ্রবিতে জাতীয় পরিসংখ্যান দিবস পালিত</h3>
                  </div>
                </div>
              </a>
            </li>        </div>
  ...
  <section class="culture-wrapper">
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-9 col-12 custom-padding">
          <div class="new-heading-title">
            <h3><a href="https://www.ekusheysangbad.com/country"><span> সারাবাংলা </span></a></h3>
          </div>
          <!--/.new-heading-title-->
          <div class="country-news-main">

            
            <div class="country-news-left">
              <div class="country-news-lead">
                <a href="https://www.ekusheysangbad.com/country/news/343537">
                  ...
                  <div class="country-news-lead-text">
                    <span>  </span>
                    <h2>যদি আওয়ামী লীগ ক্ষমতায় থাকে, আপনারা আর কোনোদিন ভোট দিতে পারবেন নাঃ চট্টগ্রামে মির্জা আব্বাস</h2>
                  </div>
                </a>
              </div>
              <div class="country-news-lead">
                <a href="https://www.ekusheysangbad.com/country/news/343536">
                  ...
                  <div class="country-news-lead-text">
                    <span>  </span>
                    <h2>রাজশাহীতে অটো গ্যারেজে আগুন, ৬০ লক্ষ টাকার ক্ষয়-ক্ষতি</h2>
                  </div>
                </a>
              </div>
      </div>
            <div class="country-news-middle">
              <ul class="country-news-ul">
          <li>
            <a href="https://www.ekusheysangbad.com/country/news/343535">
          ...
          <li>
            <a href="https://www.ekusheysangbad.com/country/news/343508">
              ...
              <div class="country-news-ul-right">
                ...
                <h3>লালমোহনে পুকুরের পানিতে ডুবে শিশুর মৃত্যু</h3>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/country/news/343507">
              ...
              <div class="country-news-ul-right">
                ...
                <h3>নরসিংদীতে মেঘনায় অবৈধ মাছের ঘের উচ্ছেদ করলো নৌ পুলিশ</h3>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/country/news/343504">
              ...
              <div class="country-news-ul-right">
                ...
                <h3>ময়মনসিংহে বেড়েই চলেছে নিত্যপণ্যের দাম</h3>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/country/news/343501">
              ...
              <div class="country-news-ul-right">
                ...
                <h3>চিলমারীতে হাট-বাজারগুলোতে ভেজাল সার ও কীটনাশক ঔষধে সয়লাব</h3>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/country/news/343498">
              ...
              <div class="country-news-ul-right">
                ...
                <h3>বাঁশখালীতে আগুনে পুড়ল ৩৪ বসত ঘর ভস্মিভুত</h3>
              </div>
            </a>
          </li>
              </ul>
        ...
        <div class="col-md-3 col-12 custom-padding">
...
viewBox="0 0 1065.105 1391" enable-background="new 0 0 1065.105 1391" xml:space="preserve">
<g>
<path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" d="M385.63,793.838l-5.29-6.266L385.63,793.838z"/>
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="357.129,748.001 355.755,745.065
355.855,741.734 355.755,745.065 	"/>
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="383.28,774.839 379.26,755.838
377.403,751.132 379.26,755.838 	"/>
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="454.193,899.819 451.844,901.699
454.195,899.819 450.276,892.862 447.144,889.926 447.142,889.926 450.276,892.862 	"/>
...
323.727,647.802 318.733,645.645 	"/>
...
418.445,574.339 421.38,576.887 	"/>
<path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" d="M662.525,380.601l-0.096,3.135L662.525,380.601z
"/>
<path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" d="M706.215,569.934l5.98,3.125L706.215,569.934z"
/>
...
447.827,908.143 447.506,909.589 447.827,908.143 446.454,906.774 446.358,905.405 447.827,902.66 447.827,902.66 	"/>
...
446.358,930.673 447.436,932.336 446.358,930.673 444.498,930.085 439.208,929.499 437.838,928.809 437.838,928.814 	"/>
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="444.397,916.96 446.258,918.04
447.239,919.115 446.258,918.034 444.4,916.96 443.517,914.903 443.517,914.903 	"/>
...
573.104,786.003 574.277,783.36 578.486,785.024 586.227,790.709 584.465,785.611 			"/>
...
l1.467-4.796l-3.818-3.037l-1.861-2.155l0.586-0.982l5.094,0.101l1.861-2.841L617.373,726.452z"/>
</a>
...
c0.677,4.059,1.86,6.963,3.551,8.726h4.057l5.58,5.683h-9.641V663.879z"/>
...
c-3.451,1.928-7.099,4.246-10.959,6.95c9.467,3.991,16.508,10.314,21.104,18.971h0.198v-30.733H525.481z"/>
...
c0.674,4.059,1.859,6.963,3.551,8.726h4.057l5.578,5.683h-9.641V663.879z"/>
</g>
</g>
<g id="Khulna">
<a xlink:href="https://www.ekusheysangbad.com/country/khulna" >
...
451.156,988.658 457.917,981.705 456.148,976.413 455.074,974.748 451.746,972.985 			"/>
...
272.403,1149.195 278.771,1152.625 281.316,1148.605 280.142,1142.339 			"/>
...
c0,0.723,0.042,1.446,0.127,2.168c0.085,0.729,0.172,1.216,0.259,1.47c0.469,1.022,1.467,1.596,3,1.727L309.725,917.502z"/>
...
C296.897,954.274,296.295,954.096,295.611,953.969z"/>
...
L341.142,917.502L341.142,917.502z"/>
...
l-3.51-3.577h34.802l3.708,3.577h-6.262V917.502z"/>
...
c0.425,2.561,1.17,4.389,2.233,5.493h2.557l3.512,3.577h-6.074V917.502z"/>
</g>
</g>
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="557.434,848.789 557.432,848.789
557.432,848.789"/>
<g id="Barishal">
<a xlink:href="https://www.ekusheysangbad.com/country/barishal">
...
583.387,1107.958 585.15,1109.133 587.207,1103.94 590.533,1103.158 589.361,1099.532 			"/>
...
564.973,1075.831 564.58,1081.218 565.854,1081.218 567.029,1078.868 576.139,1073.479 			"/>
...
620.904,1071.816 622.467,1075.049 626.189,1071.816 637.355,1054.381 639.121,1048.501 638.922,1011.579 643.137,989.832 			"/>
<polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10" points="542.836,1083.862 544.205,1078.183
541.369,1078.771 538.135,1083.959 535.393,1090.623 534.119,1095.519 535.393,1095.519 536.863,1090.717 			"/>
...
539.602,1103.158 544.896,1094.146 545.674,1089.152 			"/>
...
599.256,1001.49 599.744,1003.153 602.098,1007.853 601.604,1002.467 599.256,996.103 			"/>
...
664.588,1043.703 664.092,1041.65"/>
<polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10" points="670.168,1029.992 668.895,1034.499
668.799,1046.742 671.246,1044.585 672.711,1040.372 673.303,1035.478 673.107,1031.265 			"/>
...
663.313,1028.917 661.156,1032.831 660.471,1035.968 663.801,1037.336 			"/>
<polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10" points="603.369,984.346 602.977,981.898
602.098,979.452 600.527,978.666 599.256,992.089 600.527,990.618 603.465,988.852 			"/>
...
547.34,1110.406 550.182,1111.877 553.611,1110.211 558.51,1104.433 563.016,1101.689 565.07,1094.442 562.426,1088.368 			"/>
...
574.277,918.823 574.668,913.139 			"/>
</a>
<g enable-background="new">
...
c6.212,2.593,10.862,6.539,13.945,11.847V1011.119L455.329,1011.119z"/>
...
c7.321,0,14.314,3.458,20.978,10.365L500.187,995.32z"/>
...
c-2.221,0.819-4.474,1.808-6.755,2.959c-2.285,1.154-4.68,2.57-7.188,4.259c6.21,2.593,10.859,6.539,13.942,11.847V1011.119z"/>
...
c0.41,2.469,1.133,4.238,2.158,5.306h2.471l3.395,3.455h-5.859V1002.97z"/>
...
L589.402,1002.97L589.402,1002.97z"/>
</g>
</g>
<g id="Chittagong">
<a xlink:href="https://www.ekusheysangbad.com/country/chattogram">
...
863.025,1201.496 867.141,1200.91 872.432,1201.891 877.131,1201.694 			"/>
...
709.836,1044.097 713.266,1037.143 712.283,1029.695 			"/>
...
849.902,1117.261 851.469,1128.916 848.137,1147.821 849.902,1151.643 851.664,1149.49 856.27,1137.052 			"/>
<polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10" points="707.389,974.064 699.939,977.297
697.887,983.664 702.197,986.404 707.584,986.112 711.895,984.151 716.301,981.215 718.359,975.925 716.105,971.52 			"/>
...
1015.238,1256.838 1019.35,1252.53 1021.311,1248.902 			"/>
...
c2.768-3.262,4.156-5.938,4.156-8.036C875.994,1056.664,875.906,1056.104,875.729,1056.015z"/>
...
c2.545,1.606,3.818,4.311,3.818,8.104h2.205l3.754,3.752H896.492L896.492,1040.073z"/>
...
c-0.094,2.724,1.023,4.062,3.348,4.018c0.27,0,0.627-0.018,1.068-0.063L957.51,1040.073z"/>
...
C950.855,1078.229,951.008,1079.703,951.008,1081.668z"/>
...
c0.451,2.677,1.23,4.593,2.348,5.756h2.68l3.684,3.75h-6.359V1040.073L964.473,1040.073z"/>
...
c1.428,1.209,2.688,2.436,3.785,3.684c1.09,1.257,2.02,2.564,2.775,3.952L996.482,1067.132L996.482,1067.132z"/>
</g>
</g>
<g id="Sylhet">
<a xlink:href="https://www.ekusheysangbad.com/country/sylhet" >
...
l2.941-4.603l0.684-2.547L989.279,417.331z"/>
</a>
...
c7.662,0,14.988,3.615,21.963,10.853L793.756,484.026z"/>
...
c-1.896-3.442-2.842-7.424-2.842-11.947c0-6.288,2.561-12.425,7.688-18.412h-12.016l-3.617-3.615h23.961L830.254,492.037z"/>
...
c1.289,1.678,1.936,4.237,1.936,7.687h2.002l3.619,3.617L875.02,492.037L875.02,492.037z"/>
</g>
</g>
...
349.584,660.633 330.681,652.502 	"/>
<path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" d="M412.666,499.019l1.076-2.547L412.666,499.019z"
/>
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="413.74,496.472 416.094,493.632
417.659,487.754 417.659,487.754 416.094,493.63 	"/>
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="411.39,518.02 413.153,510.771
413.447,506.167 413.153,510.771 	"/>
...
199.626,595.203 198.256,594.027 194.929,588.933 193.949,585.41 193.949,585.41 	"/>
...
424.125,601.864 426.18,597.946 425.591,597.553 			"/>
</a>
<g enable-background="new">
...
c-2.351,0.871-4.732,1.913-7.146,3.133c-2.414,1.219-4.948,2.717-7.602,4.502c6.57,2.74,11.484,6.917,14.748,12.53V506.413z"/>
...
c0.434,2.61,1.194,4.478,2.281,5.61h2.613l3.592,3.653H231.951L231.951,497.798z"/>
...
c0.393,2.745,1.653,4.223,3.785,4.438l3.653,3.653L315.744,497.798L315.744,497.798z"/>
...
c0.436,2.61,1.198,4.478,2.284,5.61h2.614l3.586,3.653H329.121L329.121,497.798z"/>
...
c1.691-1.566,3.676-2.435,5.936-2.61c0-0.699-0.826-1.678-2.481-2.939h-13.051l-3.658-3.651h36.937L369.836,497.798z"/>
...
c1.481-0.327,2.917-0.49,4.308-0.49c11.878,0,19.58,6.417,23.102,19.252h3.522l3.592,3.651L375.454,497.798L375.454,497.798z"/>
</g>
</g>
<g id="Rangpur">
<a xlink:href="https://www.ekusheysangbad.com/country/rangpur" >
...
421.46,295.264 424.906,282.454 425.298,264.825 427.259,248.271 			"/>
</a>
<g enable-background="new">
...
C242.451,237.612,243.143,236.026,243.143,234.207z"/>
...
c0.887,1.297,1.224,2.926,1.009,4.874L274.017,233.948z"/>
...
c0.996-0.649,1.666-1.32,2.011-2.017c-0.43-0.479-0.919-0.835-1.466-1.07C277.865,267.671,277.247,267.488,276.553,267.357z"/>
...
L314.251,238.826L314.251,238.826z"/>
</g>
</g>
<g id="Mymensingh">
<a xlink:href="https://www.ekusheysangbad.com/country/mymensing" >
...
c-7.18-0.98-14.041-16.001-14.041-25.143c0-7.888,0.973-17.71,1.242-20.262l-0.984-0.112L617.279,357.874z"/>
</a>
...
c1.096,1.253,2.026,2.571,2.784,3.959L430.146,443.066L430.146,443.066z"/>
...
c1.434,1.213,2.699,2.442,3.797,3.699c1.097,1.253,2.028,2.571,2.785,3.959L500.93,443.066L500.93,443.066z"/>
...
l-3.695-3.761h36.601l3.898,3.761h-6.586v0.004h0.004V415.935z"/>
...
c3.309-2.506,6.512-3.763,9.602-3.763c7.969,0,15.582,3.763,22.836,11.284L585.342,407.604z"/>
...
c0.941,0.987,1.949,2.175,3.023,3.561v-12.896H589.842z"/>
...
C614.846,423.547,615.564,421.91,615.564,420.032z"/>
...
c1.744-1.61,3.781-2.506,6.113-2.687c0-0.719-0.85-1.722-2.553-3.022h-13.434l-3.762-3.763h38.012L659.484,415.935z"/>
</g>
</g>
<g>
<g>
...
<path fill="#DC0714" d="M277.913,153.223c0-11.305-9.166-20.47-20.476-20.47c-11.305,0-20.466,9.165-20.466,20.47
  ...
  c5.577,0,10.097,4.519,10.097,10.097c0,5.577-4.519,10.097-10.097,10.097C251.866,162.1,247.342,157.579,247.342,152.001z"/>
<circle fill="#CFF000" cx="257.441" cy="152.001" r="4.964"/>
<path fill="#DC0714" d="M269.015,186.271c-1.67,2.412-3.236,4.514-4.541,6.2c12.939,0.774,21.415,3.571,24.568,5.647
  ...
  c21.579,0,39.074-5.548,39.074-12.398C296.518,192.549,284.946,187.838,269.015,186.271z"/>
</g>
</g>
</g>
<g>
...
<path fill="#DC0714" d="M551.045,334.267c0-11.306-9.164-20.47-20.47-20.47c-11.306,0-20.47,9.164-20.47,20.47
  ...
  c5.578,0,10.101,4.518,10.101,10.095c0,5.58-4.523,10.099-10.101,10.099C525,343.145,520.476,338.626,520.476,333.046z"/>
<circle fill="#CFF000" cx="530.575" cy="333.045" r="4.964"/>
<path fill="#DC0714" d="M542.152,367.318c-1.674,2.412-3.24,4.511-4.539,6.196c12.936,0.778,21.41,3.574,24.563,5.65
  ...
  c21.581,0,39.077-5.551,39.077-12.401C569.654,373.592,558.08,368.883,542.152,367.318z"/>
</g>
</g>
</g>
<g>
...
<path fill="#0E660C" d="M525.654,586.757c0-11.304-9.164-20.47-20.472-20.47s-20.474,9.166-20.474,20.47
  ...
  c5.576,0,10.095,4.519,10.095,10.099c0,5.576-4.517,10.097-10.095,10.097C499.607,595.633,495.083,591.114,495.083,585.536z"/>
<circle fill="#FFFFFF" cx="505.19" cy="585.536" r="7.964"/>
<path fill="#0E660C" d="M516.756,619.805c-1.669,2.412-3.233,4.514-4.539,6.2c12.938,0.776,21.414,3.571,24.568,5.649
  ...
  c21.581,0,39.077-5.548,39.077-12.396C544.262,626.084,532.69,621.373,516.756,619.805z"/>
</g>
</g>
</g>
<g>
...
<path fill="#DC0714" d="M354.973,836.418c0-11.306-9.165-20.468-20.473-20.468s-20.47,9.164-20.47,20.468
  ...
  c5.578,0,10.097,4.521,10.097,10.095c0,5.579-4.519,10.103-10.097,10.103C328.927,845.297,324.404,840.774,324.404,835.194z"/>
<circle fill="#CFF000" cx="334.497" cy="835.195" r="4.964"/>
<path fill="#DC0714" d="M346.075,869.465c-1.669,2.413-3.235,4.514-4.539,6.202c12.938,0.778,21.414,3.567,24.568,5.646
  ...
  c21.579,0,39.072-5.546,39.072-12.396C373.582,875.744,362.008,871.033,346.075,869.465z"/>
</g>
</g>
</g>
<g>
...
<path fill="#DC0714" d="M948.773,958.346c0-11.312-9.164-20.47-20.473-20.47c-11.307,0-20.469,9.16-20.469,20.47
  ...
  c5.574,0,10.094,4.522,10.094,10.099c0,5.573-4.52,10.097-10.094,10.097C922.727,967.221,918.207,962.697,918.207,957.124z"/>
<circle fill="#CFF000" cx="928.301" cy="957.123" r="4.966"/>
<path fill="#DC0714" d="M939.877,991.393c-1.668,2.411-3.234,4.51-4.541,6.198c12.939,0.777,21.414,3.568,24.574,5.647
  ...
  c21.58,0,39.074-5.55,39.074-12.399C967.381,997.669,955.809,992.957,939.877,991.393z"/>
</g>
</g>
</g>
<g>
...
<path fill="#DC0714" d="M536.713,925.119c0-11.31-9.164-20.47-20.472-20.47c-11.308,0-20.47,9.162-20.47,20.47
  ...
  c5.576,0,10.097,4.522,10.097,10.096c0,5.576-4.521,10.1-10.097,10.1C510.667,933.994,506.146,929.471,506.146,923.895z"/>
<circle fill="#CFF000" cx="516.241" cy="923.898" r="4.964"/>
<path fill="#DC0714" d="M527.817,958.167c-1.671,2.412-3.237,4.509-4.539,6.197c12.935,0.777,21.412,3.575,24.566,5.647
  ...
  c21.581,0,39.075-5.55,39.075-12.399C555.322,964.442,543.748,959.731,527.817,958.167z"/>
</g>
</g>
</g>
<g>
...
<path fill="#DC0714" d="M304.658,415.999c0-11.308-9.166-20.47-20.47-20.47c-11.309,0-20.472,9.162-20.472,20.47
  ...
  c5.575,0,10.093,4.521,10.093,10.099c0,5.577-4.518,10.099-10.093,10.099C278.612,424.874,274.091,420.353,274.091,414.775z"/>
<circle fill="#CFF000" cx="284.188" cy="414.774" r="4.964"/>
<path fill="#DC0714" d="M295.764,449.047c-1.67,2.41-3.238,4.511-4.541,6.199c12.938,0.777,21.415,3.571,24.57,5.646
  ...
  c21.581,0,39.077-5.549,39.077-12.401C323.267,455.324,311.697,450.611,295.764,449.047z"/>
</g>
</g>
</g>
<g>
...
<path fill="#DC0714" d="M845.59,410.646c0-11.306-9.168-20.471-20.471-20.471c-11.311,0-20.469,9.165-20.469,20.471
  ...
  s10.098,4.519,10.098,10.097s-4.523,10.099-10.098,10.099S815.021,415.002,815.021,409.424z"/>
<circle fill="#CFF000" cx="825.115" cy="409.422" r="4.964"/>
<path fill="#DC0714" d="M836.693,443.692c-1.67,2.412-3.234,4.514-4.535,6.198c12.934,0.78,21.408,3.571,24.563,5.649
  ...
  c21.574,0,39.072-5.549,39.072-12.399C864.199,449.97,852.625,445.261,836.693,443.692z"/>
</g>
</g>
</g>
</g>
...
#Dhaka:hover .dhaka-dev path{fill: #000; cursor: pointer; transition: all 0.5s ease 0s;}
          ...
          <div class="map-form">
            <form id="search-form" method="post" action="#">
              <div class="row form-group custom-row">
                <div class="col-6 custom-padding map-padding-right">
                  <label for="division" class="sr-only">বিভাগ</label>
                  <select class="form-control division-style" name="cboDivision" id="division"
                    onchange="getDistrictList(this);">
                ...
                <div class="col-6 custom-padding map-padding-left">
                  <label for="district" class="sr-only">জেলা</label>
                  <select class="form-control division-style" name="cboDistrict" id="cboDistrict">
                    <option value="1">--জেলা--</option>
                  </select>
                </div>
              </div>
              <div class="row custom-row">
                <div class="col-6 m-auto custom-padding">
      ...
      <div class="row custom-row">
        <div class="col-sm-12 custom-padding" style="padding-top:15px">
          ...
          <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-5219299595808889"
            data-ad-slot="4181530815" data-ad-format="auto" data-full-width-responsive="true"></ins>
          <script>
          (adsbygoogle = window.adsbygoogle || []).push({});
          </script>
        </div>
    ...
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/special-report"><span class="text-span"> বিশেষ প্রতিবেদন </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
          ...
          <li>
            <a href="https://www.ekusheysangbad.com/special-report/news/337785">
              <div class="new-feature-news-single">
                ...
                <h3>   মেয়র আব্বাসের ৩ দিনের রিমান্ড মঞ্জুর  </h3>
                </div>
              </div>
            </a>
          </li>
          ...
          <li>
            <a href="https://www.ekusheysangbad.com/special-report/news/335567">
              <div class="new-feature-news-single">
                ...
                <h3>প্রতিমাসে ১৮ লাখ কর্মঘণ্টা অপচয় </h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/special-report/news/333436">
              <div class="new-feature-news-single">
                ...
                <h3>আজ মহাষ্টমী কাল মহাসপ্তমী</h3>
                </div>
              </div>
            </a>
          </li>        </div>
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="opar-bangla"><span class="text-span"> ওপার বাংলা </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
          ...
          <li>
            <a href="https://www.ekusheysangbad.com/opar-bangla/news/325516">
              <div class="new-feature-news-single">
                ...
                <h3>কলকাতায় বাংলাদেশি জঙ্গি গ্রেপ্তার</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/opar-bangla/news/325333">
              <div class="new-feature-news-single">
                ...
                <h3>অন্তরঙ্গ ছবি ফাঁসের হুমকি, তরুণীর আত্মাহত্যা</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/opar-bangla/news/324589">
              <div class="new-feature-news-single">
                ...
                <h3>ওয়েলে নেমে নজিরবিহীন বিক্ষোভ বিজেপির, শেষ না করেই বিধানসভা ছাড়লেন রাজ্যপাল</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/opar-bangla/news/323528">
              <div class="new-feature-news-single">
                ...
                <h3>নন্দীগ্রাম আসনের ফল নিয়ে হাইকোর্টে মমতা, শুনানি আজ</h3>
                </div>
              </div>
            </a>
          </li>        </div>
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="tourism"><span class="text-span"> পর্যটন </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
          ...
          <li>
            <a href="https://www.ekusheysangbad.com/tourism/news/336820">
              <div class="new-feature-news-single">
                ...
                <h3>২ ডিসেম্বর বাংলাদেশ থেকে বিমান যাবে থাইল্যান্ডে</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/tourism/news/334695">
              <div class="new-feature-news-single">
                ...
                <h3>বঙ্গবন্ধু শেখ মুজিব সাফারী পার্কে দুটি মাদি সাম্বার হরিণ অবমুক্ত</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/tourism/news/334403">
              <div class="new-feature-news-single">
                ...
                <h3>পানির বুকে ভেসে বেড়াতে চলে আসুন সাভার কায়াকিং পয়েন্টে</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/tourism/news/333121">
              <div class="new-feature-news-single">
                ...
                <h3>৯ নভেম্বর থেকে ঢাকা-মালে-ঢাকা রুটে সরাসরি ফ্লাইট শুরু করতে যাচ্ছে ইউএস-বাংলা</h3>
                </div>
              </div>
            </a>
          </li>        </div>
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="editorial"><span class="text-span"> সম্পাদকীয় </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
          ...
          <li>
            <a href="https://www.ekusheysangbad.com/editorial/news/319870">
              <div class="new-feature-news-single">
                ...
                <h3>বিজয়ী জিতে নিতে পারবেন ৩ লাখ টাকা পুরষ্কার</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/editorial/news/328704">
              <div class="new-feature-news-single">
                ...
                <h3>‍‍`পঁচাত্ত‌রের ১৫ আগস্ট‍‍` বাঙা‌লি জা‌তির সর্ব‌শ্রেষ্ঠ বি‌য়োগান্ত ঘটনা</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/editorial/news/323827">
              <div class="new-feature-news-single">
                ...
                <h3>উত্তেজিত করোনার তোপে পাঁচ ট্রেনে নিষেধাজ্ঞা</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/editorial/news/304299">
              <div class="new-feature-news-single">
                ...
                <h3>মেধাবী প্রজন্ম গড়ার প্রত্যয়</h3>
                </div>
              </div>
            </a>
          </li>        </div>
  ...
  <section class="district-news-section">
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading special-title-heading-gray">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/religious-thoughts"><span class="text-span"> ধর্মচিন্তা </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
        ...
        <ul class="new-feature-news new-feature-other">
          <li>
            <a href="https://www.ekusheysangbad.com/religious-thoughts/news/342988">
              <div class="new-feature-news-single">
                ...
                <h3>কোরআন হিফজ করল ৭ বছরের ওয়ারদা</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/religious-thoughts/news/342749">
              <div class="new-feature-news-single">
                ...
                <h3>তৈরি হচ্ছে স্বর্ণাক্ষরে লেখা সবচেয়ে বড় কোরআন</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/religious-thoughts/news/342231">
              <div class="new-feature-news-single">
                ...
                <h3>দস্তরখানে খাবার খাওয়ার ফজিলত</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/religious-thoughts/news/341843">
              <div class="new-feature-news-single">
                ...
                <h3>হিন্দু-মুসলমান এক বৃন্তে দুটি ফুল: এমপি শাহে আলম</h3>
                </div>
              </div>
            </a>
          </li>        </div>
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading special-title-heading-gray">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/literature"><span class="text-span"> সাহিত্য </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
          ...
          <li>
            <a href="https://www.ekusheysangbad.com/literature/news/343081">
              <div class="new-feature-news-single">
                ...
                <h3>আখতারুজ্জামান ইলিয়াসের পৃথিবী’ শীর্ষক আলোচনা শুক্রবার</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/literature/news/342832">
              <div class="new-feature-news-single">
                ...
                <h3>২১ ফেব্রুয়ারি বইমেলা শুরু সকাল ৮টায়</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/literature/news/342769">
              <div class="new-feature-news-single">
                ...
                <h3>চলে গেলেন একুশে পদকপ্রাপ্ত কবি কাজী রোজী</h3>
                </div>
              </div>
            </a>
          </li>        </div>
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading special-title-heading-gray">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/agriculture"><span class="text-span"> কৃষি </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
          ...
          <li>
            <a href="https://www.ekusheysangbad.com/agriculture/news/343445">
              <div class="new-feature-news-single">
                ...
                <h3>রাণীশংকৈলে গমের কাঁচা গাছ কেটে বিক্রি,উৎপাদন ব্যাহতের শঙ্কা !</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/agriculture/news/343163">
              <div class="new-feature-news-single">
                ...
                <h3>৬.৫০ লাখ মেট্রিক টন বোরো ধান সংগ্রহ করবে সরকার</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/agriculture/news/342788">
              <div class="new-feature-news-single">
                ...
                <h3>সূর্যমুখী ফুলের সৌন্দর্য দেখতে মানুষের ঢল</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/agriculture/news/342280">
              <div class="new-feature-news-single">
                ...
                <h3>কুড়িগ্রামে তিলের চাষ করে ভাগ্য বদল</h3>
                </div>
              </div>
            </a>
          </li>        </div>
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading special-title-heading-gray">
            <h2 class="title">
              <a href="https://www.ekusheysangbad.com/job-news"><span class="text-span"> চাকরির খবর </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
          ...
          <li>
            <a href="https://www.ekusheysangbad.com/job-news/news/343465">
              <div class="new-feature-news-single">
                ...
                <h3>প্রবাসীকল্যাণ ও বৈদেশিক কর্মসংস্থান মন্ত্রণালয়ের অধীনে চাকরির সুযোগ</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/job-news/news/343455">
              <div class="new-feature-news-single">
                ...
                <h3>বসুন্ধরা গ্রুপে চাকরির সুযোগ</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/job-news/news/343447">
              <div class="new-feature-news-single">
                ...
                <h3>নিউজিল্যান্ড ডেইরিতে চাকরি</h3>
                </div>
              </div>
            </a>
          </li>
          <li>
            <a href="https://www.ekusheysangbad.com/job-news/news/343366">
              <div class="new-feature-news-single">
                ...
                <h3>এটিএন নিউজে চাকরির সুযোগ</h3>
                </div>
              </div>
            </a>
          </li>        </div>
  ...
  <section class="photo-gallery-wrapper">
    <div class="container custom-container">
      <div class="photo-gallery-heading">
        <h3 class="title-bg"><a href="https://www.ekusheysangbad.com/photo">ফটো গ্যালারি</a></h3>
      </div>
      ...
      <div class="row custom-row">
        <div class="col-md-12 col-lg-7 custom-padding">
          <div class="slider-wrapper theme-default">
            <div id="slider" class="nivoSlider">
               <a href="https://www.ekusheysangbad.com/photo/157"><img class="img-fluid" src="https://www.ekusheysangbad.com/media/PhotoGallery/2022January/185718617-1900537666764743-5201297157157016777-n-20210515232257-20210522192251-20220217063817.jpg" data-thumb="https://www.ekusheysangbad.com/media/PhotoGallery/2022January/185718617-1900537666764743-5201297157157016777-n-20210515232257-20210522192251-20220217063817.jpg" alt="বন্ধুদের সঙ্গে খেলতে চাই" title="বন্ধুদের সঙ্গে খেলতে চাই" /></a>  <a href="https://www.ekusheysangbad.com/photo/167"><img class="img-fluid" src="https://www.ekusheysangbad.com/media/PhotoGallery/2020October/1-20211202115753.jpg" data-thumb="https://www.ekusheysangbad.com/media/PhotoGallery/2020October/1-20211202115753.jpg" alt="Kazi Akram Uddin Ahmed, Chairman of Standard Bank Limited, congratulates Gulzar Ahmed, Director of the bank and Proprietor of Apan Jewellers, for being elected as Vice President of the Executive Committee of Bangladesh Jewellers Samity for 2021-2023 term in a biannual election held recently." title="Kazi Akram Uddin Ahmed, Chairman of Standard Bank Limited, congratulates Gulzar Ahmed, Director of the bank and Proprietor of Apan Jewellers, for being elected as Vice President of the Executive Committee of Bangladesh Jewellers Samity for 2021-2023 term in a biannual election held recently." /></a>  <a href="https://www.ekusheysangbad.com/photo/165"><img class="img-fluid" src="https://www.ekusheysangbad.com/media/PhotoGallery/2020October/musfik-20211129150431.gif" data-thumb="https://www.ekusheysangbad.com/media/PhotoGallery/2020October/musfik-20211129150431.gif" alt="তামিম ইকবালকে টপকে টেস্টে বাংলাদেশের হয়ে  সবচেয়ে বেশি রানের মালিক হয়েছেন সাবেক অধিনায়ক মুশফিকুর রহিম।" title="তামিম ইকবালকে টপকে টেস্টে বাংলাদেশের হয়ে  সবচেয়ে বেশি রানের মালিক হয়েছেন সাবেক অধিনায়ক মুশফিকুর রহিম।" /></a>  <a href="https://www.ekusheysangbad.com/photo/164"><img class="img-fluid" src="https://www.ekusheysangbad.com/media/PhotoGallery/2020October/nora-20211128114748.gif" data-thumb="https://www.ekusheysangbad.com/media/PhotoGallery/2020October/nora-20211128114748.gif" alt=" নীল রঙের স্কার্ট ও টপের কম্বিনেশনে নেটদুনিয়ায় উত্তাপ ছড়ালেন নোরা ফতেহি।" title=" নীল রঙের স্কার্ট ও টপের কম্বিনেশনে নেটদুনিয়ায় উত্তাপ ছড়ালেন নোরা ফতেহি।" /></a>  <a href="https://www.ekusheysangbad.com/photo/163"><img class="img-fluid" src="https://www.ekusheysangbad.com/media/PhotoGallery/2020October/fe-20211125104201.jpg" data-thumb="https://www.ekusheysangbad.com/media/PhotoGallery/2020October/fe-20211125104201.jpg" alt="মালাইকা-সারা-পূজার হট জিম লুক, দেখুন কে কাকে টেক্কা দিলেন?" title="মালাইকা-সারা-পূজার হট জিম লুক, দেখুন কে কাকে টেক্কা দিলেন?" /></a>  <a href="https://www.ekusheysangbad.com/photo/162"><img class="img-fluid" src="https://www.ekusheysangbad.com/media/PhotoGallery/2020October/ser-20211125103814.jpg" data-thumb="https://www.ekusheysangbad.com/media/PhotoGallery/2020October/ser-20211125103814.jpg" alt="শিক্ষার্থীদের বিক্ষোভে উত্তাল ঢাকার রাজপথ" title="শিক্ষার্থীদের বিক্ষোভে উত্তাল ঢাকার রাজপথ" /></a>             </div>
            <!--/.nivoSlider-->
          </div>
          <!--/.slider-wrapper-->
        </div>
        <!--/.col-lg-7-->
        <div class="col-md-12 col-lg-5 custom-padding">
          <div class="row custom-row">
            

        <div class="col-md-6 col-6 custom-padding">
          <div class="photo-gallery-single">
            <a href="https://www.ekusheysangbad.com/photo/168">
              <div class="photo-gallery-image">
                <i class="fa fa-camera"></i>
                <img class="img-fluid" src="https://www.ekusheysangbad.com/media/PhotoAlbum/2022January/Untitled-8-20220127132626.jpg" alt="২৭ জানুয়ারি, ২০২২">
              </div>
              <div class="photo-gallery-text">
                <h3>২৭ জানুয়ারি, ২০২২</h3>
              </div>
            </a>
          </div>
        </div>
        ...
        <div class="col-md-6 col-6 custom-padding">
          <div class="photo-gallery-single">
            <a href="https://www.ekusheysangbad.com/photo/167">
              <div class="photo-gallery-image">
                <i class="fa fa-camera"></i>
                <img class="img-fluid" src="https://www.ekusheysangbad.com/media/PhotoAlbum/2020October/1-20211202115350.jpg" alt="০২ ডিসেম্বর, ২০২১">
              </div>
              <div class="photo-gallery-text">
                <h3>০২ ডিসেম্বর, ২০২১</h3>
              </div>
            </a>
          </div>
        </div>
        ...
        <div class="col-md-6 col-6 custom-padding">
          <div class="photo-gallery-single">
            <a href="https://www.ekusheysangbad.com/photo/166">
              <div class="photo-gallery-image">
                <i class="fa fa-camera"></i>
                <img class="img-fluid" src="https://www.ekusheysangbad.com/media/PhotoAlbum/2020October/musfik-20211129150523.gif" alt="২৯ নভেম্বর, ২০২১">
              </div>
              <div class="photo-gallery-text">
                <h3>২৯ নভেম্বর, ২০২১</h3>
              </div>
            </a>
          </div>
        </div>
        ...
        <div class="col-md-6 col-6 custom-padding">
          <div class="photo-gallery-single">
            <a href="https://www.ekusheysangbad.com/photo/165">
              <div class="photo-gallery-image">
                <i class="fa fa-camera"></i>
                <img class="img-fluid" src="https://www.ekusheysangbad.com/media/PhotoAlbum/2020October/nora-20211128114821.gif" alt="২৮ নভেম্বর, ২০২১">
              </div>
              <div class="photo-gallery-text">
                <h3>২৮ নভেম্বর, ২০২১</h3>
              </div>
            </a>
          </div>
        </div>          </div>
        ...
        <div class="contact-details">
          <ul class="footer-address-ul">
            ...
            <li>
              ...
              <span class="size-w-4">
                  +৮৮-০২-৮৩৯১৯৯৯ , ০১৭১২-৪২৮৩২৮ , ০১৬২০০০৯৫১৫
              </span>
            </li>
            <li>
              <span class="size-w-3">
            ...
            <li>
              ...
              <span class="size-w-4">
                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="59373c2e2a3c322c2a313c20773a3634193e34383035773a3634">[email&#160;protected]</a>
              </span>
            </li>
            <li>
              <span class="size-w-3">
              ...
              <span class="size-w-4">
                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f792939e839885d9929c82849f928eb7909a969e9bd994989a">[email&#160;protected]</a>
              </span>
            </li>
          </ul>
...
<div class="footer">
  <div class="container custom-container">
    <div class="row custom-row footer-bottom-row">
        <div class="col-md-6 col-12 footer-copy-text">
          <p> কপিরাইট © ২০১২ - ২০২২ সর্বস্বত্ব সংরক্ষিত | </p>
        </div>
    ...
    $.post("getDistrictList.php", {
      ...
      if (rtm.length > 0) {
        for (var i = 0; i < rtm.length; i++) {
          option += '<option value="' + rtm[i]['alias'] + '">' + rtm[i]['name'] + '</option>';
        };
        $("#cboDivision").html('');
  ...
  $("#search-form").submit(function() {
    var baseURL = "https://www.ekusheysangbad.com/"
    var division = $("#division").val();
    var district = $("#cboDistrict").val();
    if (division === "") {
      alert('একটি বিভাগ নির্বাচন করুন');
      return false;
    }
    $("#search-form").attr("action", baseURL + 'country/' + division + '/' + district);
    // alert(baseURL+division+'/'+district);
  });
