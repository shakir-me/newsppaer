                         ...
                         <div class="card-body">
                             ...
                             <form action="{{ route('store.video') }}" method="post" class="forms-sample"
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" name="link" class="form-control" id="exampleInputName1"
                                         placeholder="Video Link" required="">
                                 </div>

                                 <div class="form-group">
                                     <label for="exampleSelectGender"> Post Type</label>
                                     <select class="form-control" name="icon" id="exampleSelectGender">
                                 ...
                                 <div class="row">
                                         ...
                                         <div class="form-group">
                                             <div class="form-check">
                                                 <label class="form-check-label">
                                                     <input type="checkbox" name="first_section" class="form-check-input"
                                                         value="1">
                                                     First News
                                                 </label>
                                             </div>
                                     ...
                                     <div class="col-md-2">
                                         <div class="form-group">
                                             <div class="form-check">
                                                 <label class="form-check-label">
                                                     <input type="checkbox" name="second_section" class="form-check-input"
                                                         value="1">
                                                     Second Section
                                                 </label>
                                             </div>
