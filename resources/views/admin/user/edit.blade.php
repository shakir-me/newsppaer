                 ...
                 <div class="col-8 grid-margin stretch-card">
                     <div class="card">
                         <div class="card-body">
                             ...
                             @endif
                             <form action="{{ route('update.user', $user->id) }}" method="post" class="forms-sample"
                                 ...
                                 <div class="form-group">
                                     ...
                                     <select class="form-control" name="type" id="exampleSelectGender">
                                         ...
                                         <option value="superadmin" {{ $user->type == 'superadmin' ? 'selected' : '' }}>
                                             Super
                                             Admin</option>
                                         ...
                                         <option value="author" {{ $user->type == 'editor' ? 'selected' : '' }}>Author
                                         </option>
                                     </select>
                                 </div>
                                 ...
                                 <div class="form-group">
                                     ...
                                     <textarea class="form-control" name="about" id="summernotetwo">
                          {!! $user->about !!}
                        </textarea>
                                 </div>
                                 ...
                                 <div class="form-group">
                                     ...
                                     <img src="#" id="one">
                                     <img id="logo" src="{{ asset('admin/user/' . $user->image) }}" width="50"
                                         height="50;" />
                                 </div>
                                         ...
                                         <div class="form-group">
                                             <div class="form-check">
                                                 <label class="form-check-label">
                                                     ...
                                                     <input type="checkbox" name="video_post" value="video_post"
                                                         <?php if ($user->video_post == 'video_post') {
                                                             echo 'checked';
                                                         } ?>>
