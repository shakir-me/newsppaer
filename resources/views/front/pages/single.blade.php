 ...
 @section('facebook_meta')
    <meta property="og:url" content="{{url('single',$single_post->slug)}}">
    <meta property="og:image" content="{{asset('admin/post/'.$single_post->image) }}">
    <meta property="og:description" content="{{url('single',$single_post->short_desc)}}">
@endsection
