     ...
     <div class="row custom-row">
       <div class="col-12 custom-padding">
         <div class="privacy-content-details">
           ...
           <h3>Use of Data</h3>
           <p>Ekusheysangbad uses the collected data for various purposes:</p>
             ...
             <p>Ekusheysangbad will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
             ...
             <p>If the processing is based on your consent, you may at any time withdraw your consent by contacting us using the contact information in clause 1.</p>
             <p>In order to enter into a contract regarding the purchase of Ekusheysangbad’s Service, you must provide us with the required personal data. If you do not to provide us with all the required information, it will not be possible to deliver the Service like ads and others.</p>

             <h3>Disclosure of Data</h3>
             <h4>Legal Requirements:</h4>
             <p>ekusheysangbad.com may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
             <ul style="padding-left:40px;">
               <li>To comply with a legal obligation</li>
               <li>To protect and defend the rights or property of Ekusheysangbad</li>
             ...
             <p>We strongly protect children privacy.</p>
             <p>We do not knowingly collect personally identifiable information from anyone under the age of 18. If you are a parent or guardian and you are aware that you’re Children has provided us with Personal Data, please contact us. If we become aware that we have collected Personal Data from children without verification of parental consent, we take steps to remove that information from our servers.</p>
             ...
             <h3>Contact Us</h3>
             <p>If you have any questions about this Privacy Policy, please contact us: <a href="">/contact</a></p>
         </div>
       </div>
     </div>
   </div>
