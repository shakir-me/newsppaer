...
<input type="hidden" value="{{$category->id}}" id="category_id" />
           <ol class="breadcrumb details-page-breadcrumb">
             ...
             <li class="active"><a href=""> {{$category->name}}</a></li>
               ...
               <div class="row custom-row content_list" id="grid_view_all_data{{$category->id}}">
              ...
              <div class="row"  id="show_more_main343558">
                <div class="col-sm-12 text-center">
                  <div class="btn btn-more-details hvr-bounce-to-right">
                    <span id="ajax-loadmore-product{{$category->id}}" class="show_more" title="Load more posts">আরও খবর</span>
       ...
       <div class="right-content-area details-right-content-area">
         <div class="col-lg-12 custom-padding">
           ...
           <div class="details-right-news-heading">
             <h2>{{$category->name}} বিভাগের সর্বোচ্চ পঠিত </h2>
           </div>
