  ...
  <section class="lead-news-wrapper">
    <div class="container custom-container">
      ...
      <div class="new-lead-news-wrapper" id="slickSlider">
...
@endforeach
 ...
 <div class="col-md-4 custom-padding">
    <div class="row custom-row">  
         @foreach($lead_section as $lead)     
        <div class="col-md-12 col-6 custom-padding">
        <div class="lead-news-other-wrapper">
          <div class="lead-news-other">
            <a href="{{url('single',$lead->slug)}}">
              <div class="lead-news-other-image">
                <img src="{{asset('admin/post/'.$lead->image) }}" class="img-fluid" alt="{{asset('admin/post/'.$lead->image) }}" />
              </div>
         ...
         @endforeach
            ...
            <div class="col-md-4 col-6 custom-padding" style="flex-direction: column;">
                 @foreach($lead_one as $row)
                  <div class="col-md-4 col-6 custom-padding">
                    <div class="lead-news-second-wrapper" style="width: auto;">
     ...
     @php 
     $cats=DB::table('sub_categories')->skip(41)->first();
     $subcategory_id=$cats->id;
     $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->limit(2)->get();
        ...
        <div class="lead-news-right">
          <div class="col-md-12 custom-padding">
            <div class="special-title-heading">
              <h2 class="title">
                <a href=""><span class="text-span"> {{$cats->name}} </span></a>
                <span class="liner"></span>
              </h2>
            </div>
          
            <ul class="opinion-ul">
               @foreach($main_post as $row)
              <li>
               <a href="{{url('single',$row->slug)}}">
                <div class="opinion-left">
                 <img src="{{asset('admin/post/'.$row->image) }}" class="img-fluid rounded-circle" alt="{{$row->title}}" />
                </div>
...
@php
$ads_three=DB::table('ads')->latest()->where('ads_three','1')->limit(1)->get();
@endphp
            <div class="culture-banner-1">
             <!--  <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
              ...
              @foreach($ads_three as $row)
              <a href="{{$row->link}}" target="_black">
                <img src="{{asset('admin/ads/'.$row->image) }}" class="img-fluid rounded-circle" alt="অতিমারির ধাক্কাই কাটল না, এর ওপর ইউক্রেন যুদ্ধ, কী হবে আমাদের?" />
                </a>
              </div>
              @endforeach
  ...
  <!--/.lead-news-wrapper-->
@php
$video=DB::table('video_posts')->latest()->first();
@endphp
        ...
        <div class="video-gallery-right">
          <div class="col-md-12 custom-padding">
            ...
            <div class="tab-content" id="nav-tabContent">
               @php 
                  $videos=DB::table('video_categories')->skip(0)->first();
                  $postcategory_id=$videos->id;
                  $main_post=DB::table('video_posts')->where('postcategory_id',$postcategory_id)->where('second_section','1')->where('status',1)->get();
                ...
                <div id="featured-videos-news" class="owl-carousel">
                 @foreach($main_post as $row)
                  <div class="item">
                     ...
                     <div class="images">
                       <img src="{{asset('admin/video/'.$row->image) }}" alt="{{$row->title}}.....">
            ...
            @endforeach     
              ...
              <div class="tab-pane fade new-fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                <div id="featured-videos-section" class="owl-carousel">
                  @php 
                     $videos=DB::table('video_categories')->skip(1)->first();
                     $postcategory_id=$videos->id;
                     $main_post=DB::table('video_posts')->where('postcategory_id',$postcategory_id)->where('second_section','1')->where('status',1)->get();
            ...
            <div class="all-video-wrapper-text">
              <a href="{{url('videos')}}" class="all-videos" rel="nofollow">সকল ভিডিও দেখুন <i
...
@php 
$cats=DB::table('sub_categories')->skip(0)->first();
$subcategory_id=$cats->id;
$main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('first_section','1')->where('status',1)->first();
$lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->latest()->where('status',1)->limit(5)->get();
$lead_two=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(5)->get();
    ...
    <div class="container custom-container">
        ...
        <div class="national-news-wrapper-left new-national-news-wrapper-style">
          <div class="col-md-12 custom-padding">
            <div class="new-heading-title">
              <h3><a href="subcategory/jateez"><span> {{$cats->name}} </span></a></h3>
            </div>
            <div class="row custom-row">
      ...
      <div class="col-12 col-md-12 col-lg-5 custom-padding">
          <div class="new-style-national-big">
            <a href="{{url('single',$main_post->slug)}}">
              <img src="{{asset('admin/post/'.$main_post->image) }}" class="img-fluid" alt="{{$main_post->title}}" />
              <div class="new-style-national-big-text">
                <h2>{{$main_post->title}}</h2>
                <p>{!!$main_post->short_desc!!}.</p>
              </div>
            </a>
          </div>
        </div>
...
@foreach($lead_two as $row)
  ...
  @php 
  $cats=DB::table('sub_categories')->skip(1)->first();
  $subcategory_id=$cats->id;
  $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->first();
  $lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
  @endphp
    ...
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="subcategory/rajneeti"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
  ...
  @endforeach
        ...
        $category_id=$cats->id;
        $main_post=DB::table('posts')->where('category_id',$category_id)->where('second_section','1')->where('status',1)->first();
        $lead_post=DB::table('posts')->where('category_id',$category_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
        @endphp

        <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
            <a href="category/antrjatik"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
          ...
          <div class="new-feature-lead">
            <a href="{{url('single',$main_post->slug)}}">
              <img src="{{asset('admin/post/'.$main_post->image) }}" class="img-fluid" alt="" />
              <div class="new-feature-lead-text">
        ...
        <!--/.col-md-6 col-lg-3-->
        @php 
        $cats=DB::table('sub_categories')->skip(12)->first();
        $subcategory_id=$cats->id;
        $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->first();
        $lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
        @endphp
        <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="subcategory/swasthz"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
...
<section class="sports-wrapper">
            ...
            <div class="col-md-12 custom-padding">
               <nav class="nav-video-tab-option tab-section-option">
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                     ...
                     <a class="nav-link" id="nav-{{$cat->id}}-tab" data-toggle="tab" href="#nav-{{$cat->id}}" role="tab" aria-controls="nav-{{$cat->id}}" aria-selected="true">{{$cat->name}}</a>
                     @endforeach

                      @foreach($subcategory as $cat)
                      @php
                       $left=App\Models\Post::where('subcategory_id',$cat->id)->where('three_section','1')->limit(2)->latest()->get();
                       $middle=App\Models\Post::where('subcategory_id',$cat->id)->where('second_section','1')->limit(1)->latest()->get();
                       $right=App\Models\Post::where('subcategory_id',$cat->id)->where('four_section','1')->limit(2)->latest()->get();
                       $last=App\Models\Post::where('subcategory_id',$cat->id)->where('five_section','1')->limit(4)->latest()->get();
                      @endphp
                      @endforeach
                  </div>
               </nav>
               <div class="tab-content" id="nav-tabContent">
                 ...
                 @foreach($subcategory as $cat)
                     ...
                     @php
                      $left_side=App\Models\Post::where('subcategory_id',$cat->id)->where('three_section','1')->limit(2)->latest()->get();
                      $middle_side=App\Models\Post::where('subcategory_id',$cat->id)->where('second_section','1')->limit(1)->latest()->get();
                      $right_side=App\Models\Post::where('subcategory_id',$cat->id)->where('four_section','1')->limit(2)->latest()->get();
                      $last_side=App\Models\Post::where('subcategory_id',$cat->id)->where('five_section','1')->limit(4)->latest()->get();
                     @endphp
                 <div class="tab-pane fade new-fade" id="nav-{{$cat->id}}" role="tabpanel" aria-labelledby="nav-{{$cat->id}}-tab">
                     <div class="row custom-row">

                       <!-- leaft side -->
                        <div class="col-md-12 col-lg-3 custom-padding">
                           <div class="row custom-row">
                                 @foreach($left_side as $row)
                              <div class="col-md-6 col-lg-12 custom-padding">
                                 <div class="new-style-sports-small">
                                    <a href="{{url('single',$row->slug)}}">
                                       <div class="new-style-sports-small-image">
 ...
 @php 
     $cats=DB::table('categories')->skip(7)->first();
    $category_id=$cats->id;
   $main_post=DB::table('posts')->where('category_id',$category_id)->where('second_section','1')->where('status',1)->first();
   $lead_post=DB::table('posts')->where('category_id',$category_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
     @endphp
    ...
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="category/tthz-przukti"><span class="text-span"> {{$cats->name}}
                </span></a>
              <span class="liner"></span>
            </h2>
          </div>
        ...
        @php 
            $cats=DB::table('categories')->skip(8)->first();
           $category_id=$cats->id;
          $main_post=DB::table('posts')->where('category_id',$category_id)->where('second_section','1')->where('status',1)->first();
          $lead_post=DB::table('posts')->where('category_id',$category_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
            @endphp
        <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="/category/opradh"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
       ...
       @php 
        $cats=DB::table('sub_categories')->skip(11)->first();
        $subcategory_id=$cats->id;
        $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->first();
        $lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
        @endphp
        ...
        <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="subcategory/laifstail"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
      ...
      <div class="row custom-row">
       <div class="col-md-6 custom-padding">
          <nav class="nav-video-tab-option tab-news-option">
            ...
            <!--    <a class="nav-link" id="nav-{{$cat->id}}-tab" data-toggle="tab" href="#nav-{{$cat->id}}" role="tab" aria-controls="nav-{{$cat->id}}" aria-selected="true">{{$cat->name}}</a> -->
                    @php
                  $lead_side=App\Models\Post::where('subcategory_id',$cat->id)->where('second_section','1')->limit(2)->latest()->get();
                  $right_side=App\Models\Post::where('subcategory_id',$cat->id)->where('three_section','1')->limit(5)->latest()->get();
            ...
            <li>
              ...
              @foreach($subcategory as $cat)
                 @php
                  ...
                  $right_side=App\Models\Post::where('subcategory_id',$cat->id)->where('three_section','1')->limit(5)->latest()->get();
                @endphp
            <div class="tab-pane fade new-fade" id="nav-{{$cat->id}}" role="tabpanel" aria-labelledby="nav-us-tab">
              <div class="row custom-row">
                <div class="col-md-5 custom-padding">
                <div class="row custom-row">
                  @foreach($lead_side as $row)
  ...
  $category_id=$cats->id;
  $subcategory2=DB::table('sub_categories')->where('category_id',$category_id)->get();
  @endphp
        <div class="col-md-6 custom-padding">
          <nav class="nav-video-tab-option tab-news-option">
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <div class="nav-title nav-title-2">
                <a href="category/prbas">
                  <h3>{{$cats->name}}</h3>
                </a>
              </div>
              <a class="nav-link active show" id="nav-all-pro2" data-toggle="tab" href="#nav-all-pro2" role="tab" aria-controls="nav-all-pro" aria-selected="true"> সকল </a>
               @foreach($subcategory2 as $cat)
              <a class="nav-link" id="nav-{{$cat->id}}-tab" data-toggle="tab" href="#nav-{{$cat->id}}" role="tab" aria-controls="nav-{{$cat->id}}" aria-selected="true">{{$cat->name}} </a>
                    @php
                  $lead_side=App\Models\Post::where('subcategory_id',$cat->id)->where('second_section','1')->limit(2)->latest()->get();
                  $right_side=App\Models\Post::where('subcategory_id',$cat->id)->where('three_section','1')->limit(5)->latest()->get();
          ...
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade new-fade active show" id="nav-all-pro2" role="tabpanel" aria-labelledby="nav-all-pro2">
            <div class="row custom-row">
            <div class="col-md-5 custom-padding">
                <div class="row custom-row">
          @foreach($lead_side as $row)
  ...
  @php 
  $binodoncat=DB::table('categories')->skip(5)->first();
  $category_id=$binodoncat->id;
  $binodoncatsubcategory=DB::table('sub_categories')->where('category_id',$category_id)->get();
  @endphp
    ...
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-12 custom-padding">
          <nav class="nav-video-tab-option tab-section-option2">
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <div class="nav-title">
                  <a href="category/binodn">
                    <h3>{{$binodoncat->name}}</h3>
                  </a>
                </div>
              ...
              @foreach($binodoncatsubcategory as $binodon)
                <a class="nav-link" id="nav-{{$binodon->id}}-tab" data-toggle="tab" href="#nav-{{$binodon->id}}" role="tab" aria-controls="nav-{{$binodon->id}}" aria-selected="false">{{$binodon->name}}</a>
                @endforeach
              </div>
          </nav>
          @foreach($binodoncatsubcategory as $binodon)
          @php
            $binodon_two=App\Models\Post::where('subcategory_id',$binodon->id)->where('three_section','1')->limit(4)->latest()->get();
            $binodon_one=App\Models\Post::where('subcategory_id',$binodon->id)->where('second_section','1')->limit(1)->latest()->get();
            $binodon_three=App\Models\Post::where('subcategory_id',$binodon->id)->where('four_section','1')->limit(4)->latest()->get();
            @endphp
          @endforeach
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade new-fade active show" id="nav-entire" role="tabpanel" aria-labelledby="nav-entire-tab">        
            <div class="row custom-row">
          @foreach($binodon_one as $row)
     ...
     @foreach($binodoncatsubcategory as $binodon)
       ...
       @endphp
            ...
            <div class="tab-pane fade new-fade" id="nav-{{$binodon->id}}" role="tabpanel" aria-labelledby="nav-{{$binodon->id}}-tab">
              <div class="row custom-row">
                <div class="col-12 col-md-12 col-lg-6 custom-padding">
                 @foreach($binodon_one as $row)
                  <div class="entertainment-big">
  ...
  @php 
  $cats=DB::table('categories')->skip(6)->first();
  $category_id=$cats->id;
  $main_post=DB::table('posts')->where('category_id',$category_id)->where('second_section','1')->where('status',1)->first();
  $lead_post=DB::table('posts')->where('category_id',$category_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
  @endphp
  <section class="feature-news-wrapper">
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="category/siksha"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
    ...
    @php 
     $cats=DB::table('sub_categories')->skip(13)->first();
     $subcategory_id=$cats->id;
     $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->first();
     $lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
     @endphp
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="subcategory/gnmadhzm"><span class="text-span">  {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
...
@php 
     $cats=DB::table('sub_categories')->skip(14)->first();
     $subcategory_id=$cats->id;
     $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->first();
     $lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
     @endphp
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="subcategory/ficar"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
        ...
        @php 
           $cats=DB::table('sub_categories')->skip(15)->first();
             $subcategory_id=$cats->id;
             $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->first();
             $lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
     @endphp
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="subcategory/kzampas"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
  ...
  $category_id=$cats->id;
  $main_post=DB::table('posts')->where('category_id',$category_id)->where('three_section','1')->limit(2)->latest()->where('status',1)->get();
  $lead_post=DB::table('posts')->where('category_id',$category_id)->where('four_section','1')->latest()->where('status',1)->limit(5)->get();
  $lead_post2=DB::table('posts')->where('category_id',$category_id)->where('five_section','1')->latest()->where('status',1)->limit(5)->get();
  @endphp
    ...
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-9 col-12 custom-padding">
          <div class="new-heading-title">
            <h3><a href="category/sarabangla"><span> {{$cats->name}} </span></a></h3>
          </div>
          <!--/.new-heading-title-->
...
<g id="Dhaka">
<a xlink:href="/subcategory/dhaka" >
...
<g id="Khulna">
<a xlink:href="/subcategory/khulna" >
...
557.432,848.789"/>
<g id="Barishal">
<a xlink:href="/subcategory/brisal">
...
<g id="Chittagong">
<a xlink:href="/subcategory/cttgram">
...
<g id="Sylhet">
<a xlink:href="/subcategory/silet" >
...
394.934,359.639     "/>
<g id="Rajshahi">
<a xlink:href="/subcategory/rajsahee">
...
<g id="Rangpur">
<a xlink:href="/subcategory/rngpur" >
...
<g id="Mymensingh">
<a xlink:href="/subcategory/mymnsingh" >
...
@endphp
          <div class="map-form">
            <form action="{{url('post/get')}}" method="Get">
              @csrf
              <div class="row form-group custom-row">
                ...
                <div class="col-6 custom-padding map-padding-left">
                  ...
                  <select class="form-control" name="upzila_id">
                  </select>
                </div>
              </div>
              <div class="row custom-row">
  ...
  <!--/.culture-wrapper-->
  @php 
   $cats=DB::table('sub_categories')->skip(16)->first();
    ...
    <div class="container custom-container">
      <div class="row custom-row">
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="subcategory/bisesh-prtibedn"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading--> 
 ...
 @endforeach
        ...
        @php 
         $cats=DB::table('sub_categories')->skip(17)->first();
         $subcategory_id=$cats->id;
         $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->first();
         $lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
         @endphp
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-0 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="subcategory/oopar-bangla"><span class="text-span"> {{$cats->name}}</span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
        ...
        @php 
         $cats=DB::table('sub_categories')->skip(18)->first();
         $subcategory_id=$cats->id;
         $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->first();
         $lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
         @endphp
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="subcategory/prztn"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
        ...
        @php 
         $cats=DB::table('sub_categories')->skip(19)->first();
         $subcategory_id=$cats->id;
         $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->first();
         $lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
         @endphp
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading">
            <h2 class="title">
              <a href="subcategory/smpadkeez"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
  ...
  @php 
   $cats=DB::table('sub_categories')->skip(20)->first();
   $subcategory_id=$cats->id;
   $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->first();
   $lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
   @endphp
      ...
      <div class="row custom-row">
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading special-title-heading-gray">
            <h2 class="title">
              <a href="subcategory/dhrmcinta"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
  ...
  @php 
    $cats=DB::table('sub_categories')->skip(21)->first();
    $subcategory_id=$cats->id;
    $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->first();
    $lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
    @endphp
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading special-title-heading-gray">
            <h2 class="title">
              <a href="subcategory/sahitz"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
   ...
   @php 
    $cats=DB::table('sub_categories')->skip(22)->first();
    $subcategory_id=$cats->id;
    $main_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('second_section','1')->where('status',1)->first();
    $lead_post=DB::table('posts')->where('subcategory_id',$subcategory_id)->where('three_section','1')->latest()->where('status',1)->limit(4)->get();
  @endphp
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading special-title-heading-gray">
            <h2 class="title">
              <a href="subcategory/krrishi"><span class="text-span"> {{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
          <!--/.special-title-heading-->
 ...
 @endforeach
    ...
    @php 
     $cats=DB::table('sub_categories')->skip(23)->first();
     ...
     @endphp
        ...
        <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
          <div class="special-title-heading special-title-heading-gray">
            <h2 class="title">
              <a href="subcategory/cakrir-khbr"><span class="text-span">{{$cats->name}} </span></a>
              <span class="liner"></span>
            </h2>
          </div>
  ...
  <section class="photo-gallery-wrapper">
    <div class="container custom-container">
      <div class="photo-gallery-heading">
        <h3 class="title-bg"><a href="">ফটো গ্যালারি</a></h3>
      </div>
        ...
        <div class="col-md-12 col-lg-7 custom-padding">
          <div class="slider-wrapper theme-default">
            <div id="slider" class="nivoSlider">
              @foreach($gallary_one as $row)
               <a href="">
                <img class="img-fluid" src="{{asset('admin/gallary/'.$row->image) }}" data-thumb="{{asset('admin/post/'.$row->image) }}" alt="{{$row->name}}" title="{{$row->name}}" />
              </a> 
          ...
          <div class="photo-gallery-single">
            <a href="https://www.ekusheysangbad.com/photo/168">
              <div class="photo-gallery-image">
                ...
                <img class="img-fluid" src="{{asset('admin/gallary/'.$row->image) }}" alt="{{$row->name}}">
              </div>
      ...
      $(document).ready(function() {
           $('select[name="division_id"]').on('change', function(){
               ...
               if(division_id) {
                 ...
                 $.ajax({
                     url: "{{  url('/get/division_new/') }}/"+division_id,
                     type:"GET",
                     dataType:"json",
      ...
      $(document).ready(function() {
           $('select[name="distric_id"]').on('change', function(){
               ...
               if(distric_id) {
                 ...
                 $.ajax({
                     url: "{{  url('/get/distric_new/') }}/"+distric_id,
                     type:"GET",
                     dataType:"json",
                     success:function(data) {
