      ...
      <div class="col-md-12 custom-padding">
        <div class="marquee-block">
          ...
          <ul class="marquee">
            ...
            <li><a href="{{url('single',$heading->slug)}}"><span><img class="img-fluid" src="{{asset('front/icon.png')}}" alt="{{$heading->title}}"></span> {{$heading->title}}</a></li>
            ...
            <div class="col-md-4 col-6 custom-padding" style="flex-direction: column;">
                 @foreach($lead_one as $row)
                  <div class="col-md-4 col-6 custom-padding">
                    <div class="lead-news-second-wrapper" style="width: 285px;">
