  ...
  @section('main_content')
      <section class="lead-news-wrapper">
          <div class="container custom-container">
              <div class="row custom-row">
                            ...
                            <div class="col-md-4 custom-padding">
                                                ...
                                                <div class="lead-news-other">
                                                    <a href="{{ url('single', $lead->slug) }}">
                                                        <div class="lead-news-other-image">
                                                            <img src="{{ asset('admin/post/' . $lead->image) }}"
                                                                class="img-fluid" style="    min-height: 130px;
                                                                max-height: 130px;"
                                                                alt="{{ asset('admin/post/' . $lead->image) }}" />
                                                        </div>
                                                        <div class="lead-news-other-heading" style="min-height: 40px;">

                                                            <h2 style="
                                                           
                                                                text-overflow: ellipsis;
                                                                white-space: nowrap;
                                                                overflow: hidden;">{{ $lead->title }}</h2>
                                                        </div>
                                                    </a>
                                                </div>
                              ...
                              <div class="col-md-8 col-12 custom-padding">
                                  ...
                                  <div class="new-lead-news-wrapper" id="slickSlider">
                                      @php
                                          $slider_section = App\Models\Post::where('first_section',1)
                                              ->latest()
                                              ->get();
                                      @endphp
                                      @foreach ($slider_section as $row)
                                          <div class="new-lead-news">
                                              <a href="{{ url('single', $row->slug) }}">
                                                  <div class="new-lead-news-image">
                                                      <img src="{{ asset('admin/post/' . $row->image) }}"
                                                          class="img-fluid" alt="{{ $row->title }}" />

                                                          <div class="new-lead-news-heading" style="    height: auto;
                  ...
                  @php
                      $cats = DB::table('sub_categories')
                          ->skip(41)
                          ->first();
                      $subcategory_id = $cats->id;
                      $main_post = DB::table('posts')
                          ->where('subcategory_id', $subcategory_id)
                          ->where('second_section', '1')
                          ->where('status', 1)
                          ->limit(3)
                          ->get();
                                  ...
                                  <li>
                                      <a href="{{ url('single', $row->slug) }}">
                                          <div class="opinion-left">
                                              <img src="{{ asset('admin/post/' . $row->image) }}"
                                                  class="img-fluid rounded-circle" alt="{{ $row->title }}" />
                                          </div>
                      ...
                      (adsbygoogle = window.adsbygoogle || []).push({});
                              ...
                              @foreach ($ads_three as $row)
                                  <a href="{{ $row->link }}" target="_black">
                                      <img src="{{url('/front/default_image.png')}}" data-original="{{ asset('admin/ads/' . $row->image) }}" class="img-fluid rounded-circle"
                                          alt="অতিমারির ধাক্কাই কাটল না, এর ওপর ইউক্রেন যুদ্ধ, কী হবে আমাদের?" />
                                  </a>
                          </div>
                          @endforeach --}}
    @php
    ...
    @endphp
                          ...
                          <div style="padding: 20px 0;overflow: hidden;">
                            <div class="fb-page" data-href="{{$seo->fbpage_link}}" data-tabs="" data-width="" data-height="" data-small-header="false" data-adapt-container-width="false" data-hide-cover="false" data-show-facepile="false">
                             
                              <blockquote cite="{{$seo->fbpage_link}}" class="fb-xfbml-parse-ignore"><a href="{{$seo->fbpage_link}}">
@php
    ...
    @endphp  
                              ...
                              <div class="tab-content new-page-style-3" id="pills-tabContent">
                                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                      ...
                                      <div class="latest-news">
                                          <ul class="latest-news-ul" style="max-height: 525px;">
                              ...
                              <div class="video-lead-wrapper-news">
                                  <a href="{{ url('video', $video->slug) }}">
                                      <div class="video-lead-wrapper-image">
                                          ...
                                          <img class="img-fluid" src="{{ asset('admin/video/' . $video->image) }}"
                                              alt="{{ $video->title }}">
                                      </div>
                  ...
                  <div class="video-gallery-right">
                      <div class="col-md-12 custom-padding">
                          <nav class="nav-video-tab-option">
                              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                  ...
                                  <a class="nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile"
                                      role="tab" aria-controls="nav-profile" aria-selected="false"> ফিচার </a>
                                  <a class="nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact"
                                      role="tab" aria-controls="nav-contact" aria-selected="false"> ফেসবুক লাইভ </a>
                              </div>
                          </nav>
                          ...
                          <div class="tab-content" id="nav-tabContent">
                              @php
                                  $videos = DB::table('video_categories')
                                      ->skip(0)
                                      ->first();
                                  $postcategory_id = $videos->id;
                                  $main_post = DB::table('video_posts')
                                      ->where('postcategory_id', $postcategory_id)
                                      ->where('second_section', '1')
                                      ->where('status', 1)
                                      ->get();
                                      ...
                                      @foreach ($main_post as $row)
                                          <div class="item">
                                              <a href="{{ url('video', $row->slug) }}">
                                                  <div class="images">
                                                      <img src="{{url('/front/default_image.png')}}" data-original="{{ asset('admin/video/' . $row->image) }}"
                                                          alt="{{ $row->title }}.....">
                              ...
                              <div class="tab-pane fade new-fade" id="nav-profile" role="tabpanel"
                              ...
                              <div class="tab-pane fade new-fade" id="nav-contact" role="tabpanel"
      ...
      @php
          ...
          $lead_post = DB::table('posts')
              ...
              ->limit(5)
              ->get();
          $lead_two = DB::table('posts')
              ->where('subcategory_id', $subcategory_id)
              ->where('three_section', '1')
              ->latest()
              ->where('status', 1)
              ->limit(5)
              ->get();
                              ...
                              <div class="col-12 col-md-12 col-lg-5 custom-padding">
                                  <div class="new-style-national-big">
                                      <a href="{{ url('single', $main_post->slug) }}">
                                          <img src="{{url('/front/default_image.png')}}" data-original="{{ asset('admin/post/' . $main_post->image) }}" class="img-fluid"
                                              alt="{{ $main_post->title }}" />
          ...
          <div class="container custom-container">
              <div class="row custom-row">
                  ...
                  <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
                      ...
                      <div class="new-feature-lead">
                          <a href="{{ url('single', $main_post->slug) }}">
                              <img src="{{url('/front/default_image.png')}}" data-original="{{ asset('admin/post/' . $main_post->image) }}" class="img-fluid" alt="" />
                              <div class="new-feature-lead-text">
                      ...
                      <div class="col-md-12 custom-padding">
                          <nav class="nav-video-tab-option tab-section-option">
                              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                  ...
                                  <a class="nav-link active show" id="nav-all-tab" data-toggle="tab" href="#nav-all"
                                      role="tab" aria-controls="nav-all" aria-selected="true"> সকল </a>
                                  @foreach ($subcategory as $cat)
                                      <a class="nav-link" id="nav-{{ $cat->id }}-tab" data-toggle="tab"
                                  ...
                                  @foreach ($subcategory as $cat)
                                      @php
                                          $left = App\Models\Post::where('subcategory_id', $cat->id)
                                              ->where('three_section', '1')
                                              ->limit(2)
                                              ->latest()
                                              ->get();
                                          $middle = App\Models\Post::where('subcategory_id', $cat->id)
                                              ->where('second_section', '1')
                                              ->limit(1)
                                              ->latest()
                                              ->get();
                                          $right = App\Models\Post::where('subcategory_id', $cat->id)
                                              ->where('four_section', '1')
                                              ->limit(2)
                                              ->latest()
                                              ->get();
                                          $last = App\Models\Post::where('subcategory_id', $cat->id)
                                              ->where('five_section', '1')
                                              ->limit(4)
                                              ->latest()
                                              ->get();
                                      @endphp
                          ...
                          <div class="tab-content" id="nav-tabContent">
                              ...
                              <div class="tab-pane fade new-fade active show" id="nav-all" role="tabpanel"
                              ...
                              @foreach ($subcategory as $cat)
                                  @php
                                      $left_side = App\Models\Post::where('subcategory_id', $cat->id)
                                          ->where('three_section', '1')
                                          ->limit(2)
                                          ->latest()
                                          ->get();
                                      $middle_side = App\Models\Post::where('subcategory_id', $cat->id)
                                          ->where('second_section', '1')
                                          ->limit(1)
                                          ->latest()
                                          ->get();
                                      $right_side = App\Models\Post::where('subcategory_id', $cat->id)
                                          ->where('four_section', '1')
                                          ->limit(2)
                                          ->latest()
                                          ->get();
                                      $last_side = App\Models\Post::where('subcategory_id', $cat->id)
                                          ->where('five_section', '1')
                                          ->limit(4)
                                          ->latest()
                                          ->get();
                                  @endphp
                                  <div class="tab-pane fade new-fade" id="nav-{{ $cat->id }}" role="tabpanel"
                                      aria-labelledby="nav-{{ $cat->id }}-tab">
                                      <div class="row custom-row">
          ...
          <div class="container custom-container">
              <div class="row custom-row">
                  ...
                  <div class="col-md-4 col-lg-4 custom-padding mt-4 mt-md-0 mt-lg-0">
                      <div class="special-title-heading">
                          <h2 class="title">
                              <a href="subcategory/laifstail"><span class="text-span"> {{ $cats->name }}
                                  </span></a>
                              <span class="liner"></span>
                          </h2>
                      </div>
                  ...
                  <div class="col-md-6 custom-padding">
                      <nav class="nav-video-tab-option tab-news-option">
                          <div class="nav nav-tabs" id="nav-tab" role="tablist">
                              ...
                              <a class="nav-link active show" id="nav-all-pro-tab" data-toggle="tab" href="#nav-all-pro"
                                  role="tab" aria-controls="nav-all-pro" aria-selected="true"> সকল </a>


                              @foreach ($subcategory as $cat)
                                  <a class="nav-link" id="nav-{{ $cat->id }}-tab" data-toggle="tab"
                                      href="#nav-{{ $cat->id }}" role="tab" aria-controls="nav-{{ $cat->id }}"
                                      aria-selected="true">{{ $cat->name }} </a>
                                  ...
                                  @php
                                      $lead_side = App\Models\Post::where('subcategory_id', $cat->id)
                                          ->where('second_section', '1')
                                          ->limit(2)
                                          ->latest()
                                          ->get();
                      ...
                      <div class="tab-content" id="nav-tabContent">
                          <div class="tab-pane fade new-fade active show" id="nav-all-pro" role="tabpanel"
                              aria-labelledby="nav-all-pro-tab">
                              <div class="row custom-row">
                                <div class="col-md-12 custom-padding">
                                    <div class="row custom-row">
                                ...
                                <div class="col-md-12 custom-padding">
                                    <ul class="feature-news-ul tab-news-ul row">
                                        @foreach ($right_side as $row)
                                            <li class="col-md-6 custom-padding" style="padding-bottom:12px">
                                                <a href="{{ url('single', $row->slug) }}">
                                                    <div class="feature-news-single">
                                                        <div class="feature-news-left">
                                                            <img src="{{url('/front/default_image.png')}}" data-original="{{ asset('admin/post/' . $row->image) }}"
                                                        ...
                                                        <div class="feature-news-right">
                                                            ...
                                                            display: -webkit-box;
                                                            -webkit-line-clamp: 2;
                                                            -webkit-box-orient: vertical;">{{ $row->title }}</h3>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                  ...
                  <div class="col-md-6 custom-padding">
                      <nav class="nav-video-tab-option tab-news-option">
                          <div class="nav nav-tabs" id="nav-tab" role="tablist">
                              ...
                              <a class="nav-link active show" id="nav-all-pro2" data-toggle="tab" href="#nav-all-pro2"
                                  role="tab" aria-controls="nav-all-pro" aria-selected="true"> সকল </a>
                      ...
                      <div class="tab-content" id="nav-tabContent">
                          <div class="tab-pane fade new-fade active show" id="nav-all-pro2" role="tabpanel"
                              aria-labelledby="nav-all-pro2">
                              <div class="row custom-row">
                                  <div class="col-md-12 custom-padding">
                                      <div class="row custom-row">
                                          @foreach ($lead_side as $row)
      ...
      @php
          $binodoncat = DB::table('categories')
              ->skip(5)
              ->first();
          $category_id = $binodoncat->id;
          $binodoncatsubcategory = DB::table('sub_categories')
              ->where('category_id', $category_id)
              ->get();
      @endphp
                  ...
                  <div class="col-md-12 custom-padding">
                      <nav class="nav-video-tab-option tab-section-option2">
                          <div class="nav nav-tabs" id="nav-tab" role="tablist">
                              ...
                              <a class="nav-link active show" id="nav-entire-tab" data-toggle="tab" href="#nav-entire"
                                  role="tab" aria-controls="nav-entire" aria-selected="true"> সকল </a>
                              @foreach ($binodoncatsubcategory as $binodon)
                                  <a class="nav-link" id="nav-{{ $binodon->id }}-tab" data-toggle="tab"
                                      href="#nav-{{ $binodon->id }}" role="tab" aria-controls="nav-{{ $binodon->id }}"
                                      aria-selected="false">{{ $binodon->name }}</a>
                              @endforeach
                          </div>
                      </nav>
                      @foreach ($binodoncatsubcategory as $binodon)
                          @php
                              $binodon_two = App\Models\Post::where('subcategory_id', $binodon->id)
                                  ->where('three_section', '1')
                                  ->limit(4)
                                  ->latest()
                                  ->get();
                              $binodon_one = App\Models\Post::where('subcategory_id', $binodon->id)
                                  ->where('second_section', '1')
                                  ->limit(1)
                                  ->latest()
                                  ->get();
                              $binodon_three = App\Models\Post::where('subcategory_id', $binodon->id)
                                  ->where('four_section', '1')
                                  ->limit(4)
                                  ->latest()
                                  ->get();
                      ...
                      @endforeach
                      <div class="tab-content" id="nav-tabContent">
                          <div class="tab-pane fade new-fade active show" id="nav-entire" role="tabpanel"
                              aria-labelledby="nav-entire-tab">
                              <div class="row custom-row">
                          ...
                          @foreach ($binodoncatsubcategory as $binodon)
                              ...
                              <div class="tab-pane fade new-fade" id="nav-{{ $binodon->id }}" role="tabpanel"
                                  aria-labelledby="nav-{{ $binodon->id }}-tab">
                                  <div class="row custom-row">
                                      <div class="col-12 col-md-12 col-lg-6 custom-padding">
                                          @foreach ($binodon_one as $row)
                                              <div class="entertainment-big">
          ...
          <div class="container custom-container">
              <div class="row custom-row">
                  ...
                  <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
                      <div class="special-title-heading">
                          <h2 class="title">
                              <a href="subcategory/gnmadhzm"><span class="text-span"> {{ $cats->name }}
                                  </span></a>
                              <span class="liner"></span>
                          </h2>
                      </div>
                  ...
                  <div class="col-md-3 col-12 custom-padding">
                      ...
                      <div class="sonali-map">
                          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                              xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1065.105 1391"
                              enable-background="new 0 0 1065.105 1391" xml:space="preserve">
                              <g>
                                  <path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                      d="M385.63,793.838l-5.29-6.266L385.63,793.838z" />
    ...
    " />
                                  <path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                      d="M706.215,569.934l5.98,3.125L706.215,569.934z" />
    ...
    " />
                                  <polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                      points="439.206,929.499 444.498,930.085
    ...
    556.658,849.962     " />
                                  ...
                                  <g id="Dhaka">
                                      <a xlink:href="/subcategory/dhaka">
                                          <polygon fill="#0E660C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="576.332,779.537 566.342,774.253
    ...
    c0.674,4.059,1.859,6.963,3.551,8.726h4.057l5.578,5.683h-9.641V663.879z" />
                                  ...
                                  <g id="Khulna">
                                      <a xlink:href="/subcategory/khulna">
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="450.862,971.026 450.862,971.026
    ...
    451.156,988.658 457.917,981.705 456.148,976.413 455.074,974.748 451.746,972.985             " />
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="275.244,1139.104 270.344,1136.267
    ...
    272.403,1149.195 278.771,1152.625 281.316,1148.605 280.142,1142.339             " />
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="281.316,1148.609 281.316,1148.605
    281.316,1148.605            " />
                                      </a>
                                      <g enable-background="new">
                                          <path fill="#FFFFFF"
                                              d="M309.725,917.502h-5.558v37.166c-0.467-0.425-0.892-0.922-1.277-1.503
    ...
    557.432,848.789" />
                                  <g id="Barishal">
                                      <a xlink:href="/subcategory/brisal">
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="587.793,1096.888 587.793,1092.188
    ...
    583.387,1107.958 585.15,1109.133 587.207,1103.94 590.533,1103.158 589.361,1099.532          " />
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="577.412,1075.049 569.867,1081.607
    ...
    564.973,1075.831 564.58,1081.218 565.854,1081.218 567.029,1078.868 576.139,1073.479             " />
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="638.822,984.448 629.521,975.925
    ...
    539.602,1103.158 544.896,1094.146 545.674,1089.152          " />
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="596.219,990.517 593.377,987.383
    ...
    599.256,1001.49 599.744,1003.153 602.098,1007.853 601.604,1002.467 599.256,996.103          " />
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="662.629,1040.859 661.449,1042.332
    ...
    573.104,870.924" />
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="671.732,1024.899 672.617,1020.198
    ...
    556.658,849.962             " />
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="552.926,1078.183 550.182,1080.434
    ...
    547.34,1110.406 550.182,1111.877 553.611,1110.211 558.51,1104.433 563.016,1101.689 565.07,1094.442 562.426,1088.368             " />
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="577.9,909.812 581.135,908.631
    ...
    c7.321,0,14.314,3.458,20.978,10.365L500.187,995.32z" />
                                          <path fill="#FFFFFF"
                                              d="M503.024,1002.97v36.281l-1.913-2.285v0.059c-0.657-1.645-1.204-2.845-1.636-3.605
    ...
    L589.402,1002.97L589.402,1002.97z" />
                                  ...
                                  <g id="Chittagong">
                                      <a xlink:href="/subcategory/cttgram">
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="878.994,1197.676 879.482,1192.582
    ...
    863.025,1201.496 867.141,1200.91 872.432,1201.891 877.131,1201.694          " />
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="712.188,1024.409 710.031,1016.183
    ...
    709.836,1044.097 713.266,1037.143 712.283,1029.695          " />
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="857.934,1129.12 860.871,1123.336
    ...
    1015.238,1256.838 1019.35,1252.53 1021.311,1248.902             " />
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="772.721,955.064 768.313,957.409
    ...
    L798.088,492.037z" />
                                          <path fill="#FFFFFF"
                                              d="M830.254,492.037c-2.715,0.647-5.061,1.66-7.039,3.037c-1.982,1.378-3.664,3.103-5.045,5.171
    ...
    349.584,660.633 330.681,652.502     " />
                                  <path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                      d="M412.666,499.019l1.076-2.547L412.666,499.019z" />
    ...
    307.762,643.98 313.443,644.471 317.772,645.432 313.443,644.471  " />
                                  <path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10"
                                      d="M264.566,628.112l0.59,2.057L264.566,628.112z" />
    ...
    394.934,359.639     " />
                                  <g id="Rajshahi">
                                      <a xlink:href="/subcategory/rajsahee">
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="425.984,594.223 426.864,590.892
    ...
    424.125,601.864 426.18,597.946 425.591,597.553          " />
                                      ...
                                      <g enable-background="new">
                                          <path fill="#FFFFFF"
                                              d="M217.921,497.798v38.369l-2.023-2.416v0.067c-0.693-1.737-1.272-3.014-1.729-3.817
    ...
    c1.691-1.566,3.676-2.435,5.936-2.61c0-0.699-0.826-1.678-2.481-2.939h-13.051l-3.658-3.651h36.937L369.836,497.798z" />
                                          <path fill="#FFFFFF"
                                              d="M375.454,497.798v38.175l-3.591-3.655v-34.52h-5.349l-3.981-3.653h9.33
    ...
    c1.481-0.327,2.917-0.49,4.308-0.49c11.878,0,19.58,6.417,23.102,19.252h3.522l3.592,3.651L375.454,497.798L375.454,497.798z" />
                                  ...
                                  <g id="Rangpur">
                                      <a xlink:href="/subcategory/rngpur">
                                          <polygon fill="#00692C" stroke="#80C2AB" stroke-width="2" stroke-miterlimit="10"
                                              points="425.102,239.065 420.304,227.213
    ...
    c0.887,1.297,1.224,2.926,1.009,4.874L274.017,233.948z" />
                                          <path fill="#FFFFFF"
                                              d="M293.062,280.036c-0.651-0.867-1.364-1.747-2.146-2.633c-0.78-0.889-1.593-1.735-2.44-2.535
    ...
    c1.744-1.61,3.781-2.506,6.113-2.687c0-0.719-0.85-1.722-2.553-3.022h-13.434l-3.762-3.763h38.012L659.484,415.935z" />
                                  ...
                                  <g>
                                      <g>
                                          <g>
                                              <path fill="#DC0714"
                                                  d="M277.913,153.223c0-11.305-9.166-20.47-20.476-20.47c-11.305,0-20.466,9.165-20.466,20.47
      ...
      c21.579,0,39.074-5.548,39.074-12.398C296.518,192.549,284.946,187.838,269.015,186.271z" />
                                  ...
                                  <g>
                                      <g>
                                          <g>
                                              <path fill="#DC0714"
                                                  d="M551.045,334.267c0-11.306-9.164-20.47-20.47-20.47c-11.306,0-20.47,9.164-20.47,20.47
      ...
      c21.581,0,39.077-5.551,39.077-12.401C569.654,373.592,558.08,368.883,542.152,367.318z" />
                                  ...
                                  <g>
                                      <g>
                                          <g>
                                              <path fill="#0E660C"
                                                  d="M525.654,586.757c0-11.304-9.164-20.47-20.472-20.47s-20.474,9.166-20.474,20.47
      ...
      c21.581,0,39.077-5.548,39.077-12.396C544.262,626.084,532.69,621.373,516.756,619.805z" />
                                  ...
                                  <g>
                                      <g>
                                          <g>
                                              <path fill="#DC0714"
                                                  d="M354.973,836.418c0-11.306-9.165-20.468-20.473-20.468s-20.47,9.164-20.47,20.468
      ...
      c21.579,0,39.072-5.546,39.072-12.396C373.582,875.744,362.008,871.033,346.075,869.465z" />
                                  ...
                                  <g>
                                      <g>
                                          <g>
                                              <path fill="#DC0714"
                                                  d="M948.773,958.346c0-11.312-9.164-20.47-20.473-20.47c-11.307,0-20.469,9.16-20.469,20.47
      ...
      c21.58,0,39.074-5.55,39.074-12.399C967.381,997.669,955.809,992.957,939.877,991.393z" />
                                  ...
                                  <g>
                                      <g>
                                          <g>
                                              <path fill="#DC0714"
                                                  d="M536.713,925.119c0-11.31-9.164-20.47-20.472-20.47c-11.308,0-20.47,9.162-20.47,20.47
      ...
      c21.581,0,39.075-5.55,39.075-12.399C555.322,964.442,543.748,959.731,527.817,958.167z" />
                                  ...
                                  <g>
                                      <g>
                                          <g>
                                              <path fill="#DC0714"
                                                  d="M304.658,415.999c0-11.308-9.166-20.47-20.47-20.47c-11.309,0-20.472,9.162-20.472,20.47
          ...
          <div class="container custom-container">
              <div class="row custom-row">
                  <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-0 mt-lg-0">
                      <div class="special-title-heading">
                          <h2 class="title">
                              <a href="subcategory/bisesh-prtibedn"><span class="text-span"> {{ $cats->name }}
                                  </span></a>
                              <span class="liner"></span>
                          </h2>
                      </div>
                  ...
                  <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-0 mt-lg-0">
                      <div class="special-title-heading">
                          <h2 class="title">
                              <a href="subcategory/oopar-bangla"><span class="text-span">
                                      {{ $cats->name }}</span></a>
                              <span class="liner"></span>
                          </h2>
                      </div>
                  ...
                  <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
                      <div class="special-title-heading">
                          <h2 class="title">
                              <a href="subcategory/smpadkeez"><span class="text-span"> {{ $cats->name }}
                                  </span></a>
                              <span class="liner"></span>
                          </h2>
                      </div>
              ...
              <div class="row custom-row">
                  <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
                      <div class="special-title-heading special-title-heading-gray">
                          <h2 class="title">
                              <a href="subcategory/dhrmcinta"><span class="text-span"> {{ $cats->name }}
                                  </span></a>
                              <span class="liner"></span>
                          </h2>
                      </div>
                  ...
                  <div class="col-md-6 col-lg-3 custom-padding mt-4 mt-md-4 mt-lg-0">
                      <div class="special-title-heading special-title-heading-gray">
                          <h2 class="title">
                              <a href="subcategory/cakrir-khbr"><span class="text-span">{{ $cats->name }}
                                  </span></a>
                              <span class="liner"></span>
                          </h2>
                      </div>
                      ...
                      <div class="slider-wrapper theme-default">
                          <div id="slider" class="nivoSlider">
                              @foreach ($gallary_one as $row)
                                  <a href="">
                                      <img class="img-fluid" src="{{ asset('admin/gallary/' . $row->image) }}"
                                          data-thumb="{{ asset('admin/post/' . $row->image) }}" alt="{{ $row->name }}"
                                          title="{{ $row->name }}" />
                                  </a>
                              @endforeach
                                  ...
                                  <div class="photo-gallery-single">
                                      <a href="https://www.ekusheysangbad.com/photo/168">
                                          <div class="photo-gallery-image">
                                              ...
                                              <img class="img-fluid"
                                                  src="{{ asset('admin/gallary/' . $row->image) }}"
                                                  alt="{{ $row->name }}">
                                          </div>
                      ...
                      $.ajax({
                          ...
                          success: function(data) {
                              ...
                              $.each(data, function(key, value) {
                                  ...
                                  $('select[name="upzila_id"]').append('<option value="' +
